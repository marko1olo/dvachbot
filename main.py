...
def _collect_board_map_totals() -> dict:
    ...
    return totals
def _collect_queue_snapshot(queue_sizes: dict) -> dict:
...
def _collect_task_snapshot() -> dict:
    try:
...
def _collect_maps_snapshot() -> dict:
    pending_done = 0
    try:
...
def _collect_delivery_priority_snapshot() -> dict:
...
def _collect_tracemalloc_snapshot() -> dict:
    return {
...
def _collect_runtime_snapshot() -> dict:
    ...
    return {
        ...
        "queues": _collect_queue_snapshot(queue_sizes),
        "delivery_priority": _collect_delivery_priority_snapshot(),
        ...
        "maps": _collect_maps_snapshot(),
        "board_maps": _collect_board_map_totals(),
        "board_totals": _collect_board_totals_snapshot(),
        "asyncio_tasks": _collect_task_snapshot(),
        "gc_count": gc.get_count(),
        "tracemalloc": _collect_tracemalloc_snapshot(),
    }
