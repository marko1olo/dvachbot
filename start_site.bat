...
if exist "venv\Scripts\python.exe" (
    "venv\Scripts\python.exe" -X utf8 -u -m uvicorn site_tgach.main:app --host 127.0.0.1 --port 8000 --proxy-headers --forwarded-allow-ips "127.0.0.1" --timeout-keep-alive 30 --limit-concurrency 1000 --backlog 512 --log-level info
) else (
