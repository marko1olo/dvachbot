...
IMAGE_SLOGANS = [
    ...
    },
    {
        ...
        "subline": "Шедевры сетевой гнили, могильный юмор и отборная постирония."
    },
    {
        "badge": "ДУМЕРСКИЙ РАЙ",
    ...
    },
    {
        ...
        "headline": "ДУХ РАННЕГО ДВАЧА И САЖИ",
        "subline": "Бескомпромиссный интернет-террор, цинизм и абсолютная анонимность."
    },
    {
