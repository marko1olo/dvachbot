...
POLISH_DATA = {
    ...
    'replacements': {
        ...
        'злость': 'wkurw',
        'злой': 'wkurwiony',
        'устал': ['zmęczony', 'zmęczyłem się', 'ujebałem się'],
        'скучно': ['nudno', 'nuda', 'nudno jak w kościele'],
        'весело': 'wesoło',
        'смешно': ['śmieszne', 'śmiesznie', 'bekowo'],
        'страшно': ['straszne', 'strasznie', 'strach się bać'],
        'красиво': 'ładne',
        'ужасно': 'okropne',
        'любовь': 'miłość',
        'ненависть': 'nienawiść',
        ...
        'слился':['obsrał zbroję', 'spierdolił', 'poddał się', 'uciekł jak cwel', 'obsrał się', 'uciekł', 'pękł'],
        ...
        'слушаешь': ['słuchasz'],
        'слушают': ['słuchają'],
        'горит': ['pali się', 'jara się', 'płonie', 'fajczy się'],
