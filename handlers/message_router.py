...
_EXTRA_RATE_LIMIT_REJECTIONS: list[str] = [
    "У тебя кулдаун, остынь. Раз в минуту рот открывать разрешено, сиди пока тихо.",
    ...
    "Один высер в шестьдесят секунд — это твой биологический потолок. Терпи молча.",
    "Пальцы от клавиатуры оторви, припадочный. Минута тайм-аут, сиди смирно.",
