...
def _format_cultist(data: dict) -> str:
    name = data['name']
    surname = data['surname']
    city = data['city']
    street = data['street']
    fetish = data['fetish']
    details_str = data['details_str']
...
def _format_psych_eval(data: dict) -> str:
    name = data['name']
    surname = data['surname']
    fetish = data['fetish']
    details_str = data['details_str']
...
def _format_hitman(data: dict) -> str:
    name = data['name']
    surname = data['surname']
    address = data['address']
    prof = data['prof']
...
def _format_dating_app(data: dict) -> str:
    name = data['name']
    city = data['city']
    prof = data['prof']
    fetish = data['fetish']
...
def _format_ukrainian(data: dict) -> str:
    name = data['name']
    surname = data['surname']
    address = data['address']
    prof = data['prof']
...
def _format_schizo(data: dict) -> str:
    name = data['name']
    surname = data['surname']
    city = data['city']
    address = data['address']
...
def generate_deanon_info(lang: str = 'ru') -> str:
    ...
    """
    data = _generate_person_data(lang)

    if lang == 'en':
        return (
            f"<b>[DEANONYMIZATION REPORT]</b>\n\n"
            f"<b>Subject Name:</b> {data['name']} {data['surname']}\n"
            f"<b>Last Known Address:</b> {data['address']}\n"
            f"<b>Probable Occupation:</b> {data['prof']}\n"
            f"<b>Psychological Profile Note:</b> Fixation on {data['fetish']}\n\n"
