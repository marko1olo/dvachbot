...
def _generate_housing_report(name, surname, address, city, street) -> str:
    complaints = [
...
def _generate_cultist_report(name, surname, city, street, fetish, details_str) -> str:
    parts = [
...
def _generate_psych_eval(name, surname, fetish, details_str) -> str:
...
def _generate_hitman_report(name, surname, address, prof, fetish, details_str) -> str:
    import secrets
    from common.html_utils import escape_html
...
def _generate_dating_app(name, city, prof, fetish, details_str) -> str:
...
def _generate_ukrainian_report(name, surname, address, prof, fetish, details_str) -> str:
    headers = [
...
def _generate_schizo_report(name, surname, city, address, prof, fetish, details_str) -> str:
    schizo_phrases = [
...
def _generate_random_report(name, surname, city, address, prof, fetish, details_str) -> str:
...
def generate_deanon_info(lang: str = 'ru') -> str:
    ...
    if chosen_style == 'housing_report':
        return _generate_housing_report(name, surname, address, city, street)
    elif chosen_style == 'cultist':
        return _generate_cultist_report(name, surname, city, street, fetish, details_str)
    elif chosen_style == 'psych_eval':
        return _generate_psych_eval(name, surname, fetish, details_str)
    elif chosen_style == 'hitman':
        return _generate_hitman_report(name, surname, address, prof, fetish, details_str)
    elif chosen_style == 'dating_app':
        return _generate_dating_app(name, city, prof, fetish, details_str)
    elif chosen_style == 'ukrainian':
        return _generate_ukrainian_report(name, surname, address, prof, fetish, details_str)
    elif chosen_style == 'schizo':
        return _generate_schizo_report(name, surname, city, address, prof, fetish, details_str)
    else:
        return _generate_random_report(name, surname, city, address, prof, fetish, details_str)
