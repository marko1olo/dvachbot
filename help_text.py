...
HELP_TEXT_COMMANDS = [
    (
        ...
        "/token — Токен для сайта\n"
        "/ruletka — Рулетка-тред\n\n"
        "<b>Контент и Медиа:</b>\n"
        ...
        "<b>Инструменты:</b>\n"
        "/summarize — Краткий пересказ треда нейросетью\n"
...
MECHANICS_INFO_TEXT_RU = [
    "💡 <b>Как общаться:</b>\n• <b>Ответ:</b> Просто реплай на сообщение.\n• <b>Реакция:</b> Ставь реакции, автор получит анонимное уведомление."
]
