...
HELP_HUB_PAGES_RU = {
    "main": (
        "⚡ <b>Справочный Центр ТГАЧ /b/</b>\n\nДобро пожаловать в анонимную борду! Здесь нет цензуры, но есть свои правила и законы.\n\n💡 <i>Выбери нужный раздел на цветных кнопках ниже:</i>\n\n• 💬 <b>Общение</b> — Как постить, отвечать, шептать, удалять посты, WebApp и треды\n• 💰 <b>Экономика</b> — Шекели, кошелек, работа, рынок, банк, шмот и энциклопедия сетов\n• 🖼 <b>Медиа & Демы</b> — Демотиваторы, постеры с QR, хентай, баннеры и кубики d100\n• 🧠 <b>ИИ & Аналитика</b> — Саммари, прожарка, бугурты, дурка, войс Абу и фильтр слопа\n• 🎭 <b>Шизо-Режимы</b> — 15+ стилей общения на 5 минут и подкоманды Русов\n• ⚔️ <b>Разборки</b> — Ограбления, дуэли, мут-ган, баллончик, говно, взятки и пативэн\n• ⚙️ <b>Настройки</b> — Спойлеры на NSFW, фильтры слов, аура ника и API\n• 📋 <b>Все команды</b> — Полный алфавитный справочник со всеми возможностями\n• 🌐 <b>Борды & Каналы</b> — Все живые доски, каналы, сайт и техподдержка\n\n🌐 Сайт: <a href=\"https://tgach.top\">tgach.top</a> | Канал: <a href=\"https://t.me/tgach_bot\">t.me/tgach_bot</a> | Архив: <a href=\"https://t.me/tgchan_archive\">t.me/tgchan_archive</a>"
    ),
    "chat": (
        "💬 <b>Раздел: Общение, Постинг и Навигация</b>\n\n• <b>Как написать пост:</b> Просто отправь любой текст, фото, стикер, видео или голосовое боту — оно мгновенно появится на доске под анонимным номером.\n\n• <b>Как ответить анону:</b> Сделай <b>Reply (Ответить)</b> на сообщение в чате. Автор получит анонимное уведомление о реплае.\n\n• <b>Эмодзи-реакции:</b>\n  👍 <b>Лайк / База:</b> Начисляет автору <b>+12.0 ₽</b>\n  👎 <b>Сажа / Дизлайк:</b> Списывает у автора штраф <b>-5.5 ₽</b>\n  🤡, 😱, 🤔, 🤣 — Другие эмодзи отправляют автору анонимную цитату с двачевским подколом.\n\n• <code>/redact</code> — Удалить свой последний пост (отправь реплаем на него).\n• <code>/whisper &lt;текст&gt;</code> — Отправить тайный анонимный шёпот автору поста.\n• <code>/poll Тема | Вар 1 | Вар 2</code> — Создать анонимное голосование.\n• <code>/report</code> — Отправить жалобу модераторам на спам, ЦП или вайп.\n• <code>/whois</code> (<code>/info</code>) — Узнать мета-информацию об авторе поста (реплаем).\n• <code>/getid</code> — Получить уникальный file_id медиафайла или ID чата.\n• <code>/app</code> — Запустить официальное интерактивное веб-приложение ТГАЧ (WebApp).\n• <code>/active</code> — Список активных анонов на борде за последние сутки.\n• <code>/threads</code> — Список активных веток обсуждений (для доски /thread/).\n• <code>/create &lt;тема&gt;</code> / <code>/cancel</code> / <code>/leave</code> — Создание, отмена и выход из треда (/thread/)."
    ),
    "economy": (
        "💰 <b>Раздел: Экономика, Казино, Предметы и Шекели</b>\n\nШекели (₪) — главная валюта борды для прокачки, экипировки, покупок и азарта:\n\n• <code>/wallet</code> — Кошелек, баланс, история операций и рефералы\n• <code>/bank</code> (<code>/deposit</code>, <code>/withdraw</code>) — <b>Банк Абу и Сейф:</b> 100% защита от /rob, вклады под процент (0.5% - 6.0%/день)\n• <code>/items</code> (<code>/wiki</code>, <code>/энциклопедия</code>) — <b>Энциклопедия предметов:</b> Полные ТТХ оружия, сетов, аптеки и кейсов\n• <code>/wardrobe</code> (<code>/boutique</code>, <code>/шмот</code>) — <b>Гардероб и Бутик:</b> Примерка и покупка скинов, шапок, очков и экипировки\n• <code>/market</code> (<code>/bazar</code>, <code>/sell</code>) — <b>P2P Барахолка:</b> Торговля шмотом, оружием и кейсами между анонами\n• <code>/shop</code> — <b>Торговый Хаб:</b> Мут-ганы, баллончики, броня, фольга, ксивы дружинника и взятки\n• <code>/rates</code> (<code>/kurs</code>, <code>/цены</code>) — Текущий биржевой курс валют и расценки на Черном Рынке\n• <code>/work</code> — Биржа труда: 15 вакансий со сбором сетов, пассивным доходом и лутом\n• <code>/pay &lt;id/reply&gt; &lt;сумма&gt;</code> — Прямой перевод шекелей другому анону без комиссии\n• <code>/ledger</code> (<code>/выписка</code>) — Бухгалтерская книга: история всех транзакций, начислений и штрафов\n• <code>/airdrop</code> — Сбросить случайный денежный аирдроп для всех участников треда\n• <code>/amulet</code> — Проверить статус или надеть Оберег от Киберчеда (защита на 7 дней)\n• <code>/casino</code> — Казино: <code>/slots</code>, <code>/coinflip</code>, <code>/blackjack</code>, <code>/rroulette</code>, <code>/ttt</code>, <code>/dice_duel</code>, <code>/duel_rr</code>\n• <code>/ttt &lt;ставка&gt;</code> — ❌⭕ Крестики-Нолики PvP на шекели (таймер 60 сек)\n• <code>/dice_duel &lt;ставка&gt;</code> — 🎲 PvP Дайс-Дуэль 2d6 на шекели (честный генератор ⚀⚁⚂⚃⚄⚅)\n• <code>/duel_rr &lt;ставка&gt;</code> — 💀 Русская Рулетка PvP (6 камор, 1 патрон, проигравшему мут 30 мин)\n• <code>/lootbox</code> — Кейсы: Мусорный пакет (150₪) и Золотой сейф (500₪)\n• <code>/avatar</code> — Карточка персонажа RPG и гардероб экипировки\n• <code>/ach</code> (<code>/achievements</code>) — Зал достижений (12 трофеев с выплатой шекелей)\n• <code>/drop &lt;сумма&gt;</code> — Сбросить пачку шекелей в тред на реакцию\n• <code>/daily</code> — Ежедневный бонус (+75 ₪ + стрик)\n• <code>/top</code> (<code>/gtop</code>, <code>/global_top</code>) — Список самых богатых китов и олигархов борды"
    ),
    "media": (
        "🖼 <b>Раздел: Медиа, Инвайты, Баннеры и Демотиваторы</b>\n\n• <code>/banner</code> (<code>/баннер</code>, <code>/gallery</code>) — <b>Интерактивная галерея баннеров ТГАЧ</b> (1657 артов и видео, 23 категории, сортировка А-Я / Случайно, постраничный просмотр).\n• <code>/random</code> (<code>/randpic</code>, <code>/randvid</code>) — Показать случайный арт или анимированное 1080p видео из коллекции баннеров.\n• <code>/dem Заголовок | Подпись</code> — <b>Генератор демотиваторов!</b> Ответь реплаем на любое фото/картинку, и бот соберёт каноничный постер с чёрной рамкой и шрифтом Impact.\n• <code>/invite_pic</code> — Сгенерировать стильный постер с QR-кодом для вербовки друзей (7 визуальных стилей: Киберпанк, Демотиватор, Матрица, Аниме, Вейпорвейв и др.).\n• <code>/invite</code> — Получить порцию отборных текстовых фраз для зазыва анонов.\n• <code>/fap</code> (<code>/hent</code>, <code>/nsfw</code>) [число] — Случайный аниме/хентай арт (можно писать <code>/fap 5</code> для пака из 5 штук).\n• <code>/loli</code> [число] — Лоликон-арт (безопасный/этти).\n• <code>/roll</code> (<code>/dice</code>, <code>/рулетка</code>) — Бросить кубик удачи от 0 до 100.\n• <code>/roll100</code> (<code>/d100</code>) — Бросок стогранной кости от 1 до 100.\n• <code>/ruletka</code> — Перейти в случайный тред борды."
    ),
    "ai": (
        "🧠 <b>Раздел: Нейросети, Аналитика, Генераторы & Постеры</b>\n\n• <code>/stats_hub</code> (<code>/пульс</code>, <code>/deck</code>) — <b>Главный пульт аналитики!</b> Мгновенный пульс со спарклайнами, инлайн-меню постеров и ссылка на WebApp.\n• <code>/my_wrapped</code> (<code>/wrapped</code>, <code>/паспорт</code>) — <b>Персональный 2ch Wrapped:</b> HD-постер с архетипом личности, хронотипом, спарринг-партнерами и диагнозом ИИ.\n• <code>/economy_stats</code> (<code>/econ</code>, <code>/казна</code>) — HD-срез теневой экономики, казино и грабежей.\n• <code>/pvp_stats</code> (<code>/война</code>, <code>/пвп</code>) — HD-срез войн дебаффов, метания говна и брони фольги.\n• <code>/drama_stats</code> (<code>/бифы</code>, <code>/враги</code>) — HD-карта заклятых врагов, токсичности досок и ночного психоза.\n• <code>/memes_stats</code> (<code>/баян</code>, <code>/мемы</code>) — HD-баянометр вирусных мемов, AI-тегов и сленга.\n• <code>/passport</code> (<code>/me</code>) / <code>/mystats</code> — Паспорт Тгачера и карта деградации с рангом, балансом и экипировкой.\n• <code>/dossier</code> (<code>/досье</code>) — Личное дело анона из картотеки КГБ (себе или реплаем).\n• <code>/summarize</code> (<code>/саммари</code>) — ИИ анализирует последние 50 постов треда и выдает суть.\n• <code>/roast</code> (<code>/прожарка</code>) — Жёсткая нейросетевая прожарка атмосферы борды.\n• <code>/slop</code> (<code>/слоп</code>) — <b>Фильтр нейрослопа:</b> Управление показом авто-роастов ИИ (<code>/slop hide</code> / <code>/slop show</code>).\n• <code>/bugurt</code> (<code>/бугурт</code>, <code>/паста</code>) — Генератор классических двачевских бугуртов (текстом или реплаем).\n• <code>/psychiatry</code> (<code>/дурка</code>, <code>/псих</code>) — Журнал карательной психиатрии: официальный диагноз и курс галоперидола.\n• <code>/abu_voice</code> (<code>/войс</code>, <code>/голос</code>) — Озвучить текст сочным голосом Абу из Дубая.\n• <code>/holiday</code> (<code>/праздник</code>) — Какой сегодня праздник и повод выпить на борде.\n• <code>/stats</code> / <code>/board_stats</code> — Графики и подробная сводка активности доски.\n• <code>/graph</code> — Визуальный таймлайн динамики постов за 90 дней.\n• <code>/tags</code> / <code>/wordcloud</code> — Облако ключевых тем и популярных слов за сутки."
    ),
    "modes": (
        "🎭 <b>Раздел: Шизо-Режимы Общения (на 5 минут)</b>\n\nАктивация режима меняет стиль и лексику всех твоих постов на 5 минут:\n\n• 🌸 <code>/anime</code> — Няшный они-чан с кавайными вздохами\n• 🇷🇺 <code>/zaputin</code> — Патриотический Z-режим, ГОЙДА и скрепы\n• 🇺🇦 <code>/slavaukraine</code> — Шаровары, перемога и хуторской диалект\n• ⚔️ <code>/warhammer</code> — Инквизиция, слава Омниссии и еретики\n• 📜 <code>/imperial</code> — Дореволюционный слог с ятями и сударями\n• 👊 <code>/gopnik</code> — Семки, кенты, мобилы и базар по понятиям\n• 🧠 <code>/schizo</code> — Теории заговора, рептилоиды и галоперидол\n• 🇵🇱 <code>/polish</code> — Пше-пше, курва я пердоле\n• 🐊 <code>/rus</code> — <b>Русы Против Ящеров v6.0:</b> Лекции Багирова, Дрочеслав на мамонте, перехваты ящеров, бугурты и славянский зажим\n• 🐒 <code>/abu</code> — Суржик создателя всея Двача\n• 🕶 <code>/matrix</code> — Избранный Нео и зеленый терминал\n• 📟 <code>/oldweb</code> — Эпоха модемов 56k, Web 1.0 и FIDO\n• ✡️ <code>/jewish</code> — Таки гешефт, маца и кошерный бизнес\n• 🦅 <code>/america</code> — Freedom, капитализм и бургеры\n• ⏹️ <code>/stop</code> — Остановить активный режим\n\n🐊 <b>Русы Против Ящеров — интерактивные команды:</b>\n• 🎓 <code>/bagirov</code> (<code>/багиров</code>, <code>/лекция</code>) — Лекция проф. Багирова (Гиперборея МГУ)\n• ⚔️ <code>/drocheslav</code> (<code>/дрочеслав</code>, <code>/рейд</code>, <code>/мамонт</code>) — Рейд Дрочеслава на мамонте против ящеров\n• 🧬 <code>/yashchertest</code> (<code>/ящертест</code>, <code>/днк</code>, <code>/чистота_крови</code>) — ДНК-тест чистоты славянской крови\n• ⚖️ <code>/veche</code> (<code>/вече</code>, <code>/суд_русов</code>) — Суд Новгородского Вече над анонами\n• 🌌 <code>/horoscope_rus</code> (<code>/чертог</code>, <code>/звездочет</code>) — Славяно-арийский гороскоп (Чертоги Сварога)\n• 📜 <code>/slav_trade</code> (<code>/грамота</code>, <code>/купец</code>) — Торговая грамота Новгородского купечества\n• 🚀 <code>/hyperborea</code> (<code>/гиперборея</code>, <code>/вимана</code>) — Летопись Гипербореи (Виманы vs Ящеры)\n• ⚡ <code>/slav_curse</code> (<code>/проклятие_ящерам</code>, <code>/анафема</code>, <code>/заклятие</code>) — Заклятие волхвов против ящеровых инфильтраторов"
    ),
    "actions": (
        "⚔️ <b>Раздел: Разборки, Дуэли, Оружие и Интерактив</b>\n\nВсе эти команды применяются <b>ответом (Reply)</b> на пост неугодного анона:\n\n• <code>/shoot</code> — <b>Выстрел из Мут-Гана:</b> Замутить неугодного анона на 1 час (требует Мут-Ган из /shop).\n• <code>/pepperspray</code> — <b>Перцовый баллончик:</b> Залить глаза едким газом и наложить слепоту (требует /shop).\n• <code>/bribe</code> — <b>Взятка майору:</b> Снять наручники, мут и откупиться от карателей (требует Взятку из /shop).\n• <code>/cure</code> — <b>Аминазин:</b> Моментально смыть любые дебаффы (говно, блевоту, шизу, флаги).\n• <code>/rob</code> — <b>Ограбление:</b> Шанс украсть 10-30% шекелей прямо из кошелька жертвы.\n• <code>/shit</code> — Запустить свежим куском говна в автора поста.\n• <code>/vomit</code> — Залить пост оппонента токсичной рвотой ради унижения.\n• <code>/curse</code> — Наложить проклятие: следующие посты жертвы будут искажаться шизо-стилем.\n• <code>/partyvan</code> — Вызвать пативэн с мигалками и отправить анона в КПЗ.\n• <code>/opushchenie</code> (<code>/параша</code>, <code>/петух</code>) — Зачитать приговор и определить омежку к параше.\n• <code>/duel &lt;сумма&gt;</code> — Бросить перчатку и сойтись в перестрелке на шекели (50/50).\n• <code>/accept</code> / <code>/decl</code> — Принять или отклонить брошенный вам вызов на дуэль.\n• <code>/ttt &lt;сумма&gt;</code> — Вызвать на PvP-дуэль в Крестики-Нолики 3x3 на шекели (таймер 60 сек).\n• <code>/dice_duel &lt;сумма&gt;</code> — Вызвать на бросок костей 2d6 на шекели (⚀⚁⚂⚃⚄⚅).\n• <code>/duel_rr &lt;сумма&gt;</code> — Вызвать на Русскую Рулетку PvP на шекели (проигравшему мут 30 мин).\n• <code>/deanon</code> — Шуточный спуфинг-деанон с генерацией фейкового IP и пробива.\n• 🗳️ <code>/votemute</code> — <b>Народный Вотум / Шизо-Мут:</b> Выдвинуть пост нарушителя на голосование. 5 голосов анонов за 10 минут отправляют шиза в <b>ЖЕЛЕЗНЫЙ МУТ на 30 минут</b> (не продается за взятки в /shop!).\n• 📋 <code>/dopros</code> (<code>/допрос</code>) — <b>Вызов на допрос в Отдел «К»</b> (себе или реплаем). Дай взятку 50₪, возьми 51-ю статью или сдай соседа по борде!\n• 🪪 <code>/fine</code> (<code>/штраф</code>, <code>/druzhina</code>) — <b>Штраф от Дружинника (Reply)</b>. Требует «Удостоверение дружинника» из /shop. Штрафует нарушителя на 15 ₪ (10 ₪ дружиннику, 5 ₪ в Фонд Абу) раз в сутки."
    ),
    "settings": (
        "⚙️ <b>Раздел: Настройки, Фильтры и Персонализация</b>\n\n• <code>/color</code> — Выбрать цвет неоновой ауры и бейджа ника (градиенты, неон, киберпанк).\n• <code>/slop</code> (<code>/slop hide</code> / <code>/slop show</code>) — Управление показом нейрослопа и авто-роастов ИИ.\n• <code>/nsfw</code> — Переключить авто-спойлер на все входящие медиафайлы (безопасно для учебы/работы).\n• <code>/hide &lt;слово&gt;</code> — Добавить слово в персональный черный список (посты с ним скроются).\n• <code>/togglegif</code> — Скрыть тяжелые GIF-анимации для экономии мобильного трафика.\n• <code>/token</code> — Получить персональный ключ авторизации для Web-интерфейса ТГАЧ (tgach.top).\n• <code>/admin</code> — Панель модератора борды (только для администрации)."
    ),
    "all": (
        "📋 <b>Полный каталог всех команд ТГАЧ:</b>\n\n<b>Общение:</b> /start, /help, /redact, /whisper, /poll, /report, /whois, /getid, /app, /active, /threads, /create, /cancel, /leave, /quote, /dice\n<b>Профиль & Досье:</b> /passport (/me, /я, /паспорт), /my_wrapped (/wrapped), /mystats (/карта, /деградация), /dossier, /inv, /wardrobe (/бутик, /шмот), /items (/wiki, /энциклопедия), /achievements (/ach), /amulet, /color\n<b>Аналитика & Графика:</b> /stats_hub (/пульс, /deck), /stats, /graph, /board_stats (/bstats), /global_top (/gtop), /economy_stats (/econ), /pvp_stats (/война), /drama_stats (/бифы), /memes_stats (/баян), /tags, /wordcloud\n<b>Экономика & Казино:</b> /wallet, /bank, /deposit, /withdraw, /market, /sell, /my_lots, /work, /daily, /shop, /rates (/цены), /ledger (/выписка), /pay (/перевод), /airdrop, /top, /duel, /ttt, /dice_duel, /duel_rr, /drop, /casino, /lootbox\n<b>Медиа:</b> /banner, /random (/randpic, /randvid), /dem, /invite_pic, /invite, /fap, /loli, /roll, /roll100 (/d100), /ruletka\n<b>ИИ & Генераторы:</b> /summarize, /roast, /slop, /bugurt (/бугурт, /паста), /psychiatry (/дурка), /abu_voice (/войс, /голос), /holiday (/праздник)\n<b>Интерактив (Reply):</b> /dossier, /rob, /shit, /curse, /partyvan, /deanon, /shoot, /pepperspray, /bribe, /cure, /vomit, /opushchenie, /votemute, /dopros, /fine, /accept, /decl\n<b>Настройки:</b> /nsfw, /hide, /togglegif, /token, /slop, /color\n<b>Режимы:</b> /anime, /zaputin, /slavaukraine, /warhammer, /imperial, /gopnik, /schizo, /polish, /rus, /abu, /matrix, /oldweb, /jewish, /america, /stop\n<b>Русы vs Ящеры (подкоманды):</b> /bagirov (/багиров, /лекция), /drocheslav (/дрочеслав, /рейд, /мамонт), /yashchertest (/ящертест, /днк), /veche (/вече), /horoscope_rus (/чертог, /звездочет), /slav_trade (/грамота, /купец), /hyperborea (/гиперборея, /вимана), /slav_curse (/проклятие_ящерам, /анафема)\n<b>Доски:</b> /b/, /a/, /po/, /soc/, /sex/, /h/, /bunker/, /vg/, /v/, /tech/, /ai/, /wh40k/, /mu/, /tv/, /fit/, /sci/, /biz/, /news/, /fa/, /x/, /vt/, /au/, /me/, /int/, /meta/, /thread/"
    ),
    "boards": (
...
HELP_HUB_PAGES_EN = {
    "main": (
        "⚡ <b>TGACH /b/ — Help & Documentation Hub</b>\n\nWelcome to the anonymous imageboard! Choose a category below using interactive buttons:\n\n• 💬 <b>Chat</b> — Posting, replying, secret whispers, redaction, WebApp & threads\n• 💰 <b>Economy</b> — Shekels, wallet, jobs, bank, P2P market, items encyclopedia & wardrobe\n• 🖼 <b>Media & Demotivators</b> — Custom /dem creator, QR posters, 1650+ banners, art & d100 dice\n• 🧠 <b>AI & Analytics</b> — Summaries, roasts, bugurts, psych ward, Abu voice & slop filter\n• 🎭 <b>Speech Modes</b> — 15+ fun conversational styles & Ancient Rus subcommands\n• ⚔️ <b>Action & PvP</b> — Robberies, duels, mute-gun, pepper spray, poop, bails & police vans\n• ⚙️ <b>Settings</b> — NSFW filters, word blocklists, nick aura & API tokens\n• 📋 <b>All Commands</b> — Complete alphabetized index across all bot modules\n• 🌐 <b>Boards & Channels</b> — All active boards, TG channels, web portal & support\n\n🌐 Web: <a href=\"https://tgach.top\">tgach.top</a> | News: <a href=\"https://t.me/tgach_bot\">t.me/tgach_bot</a> | Archive: <a href=\"https://t.me/tgchan_archive\">t.me/tgchan_archive</a>"
    ),
    "chat": (
        "💬 <b>Section: Chat, Posting & Navigation</b>\n\n• <b>Post:</b> Send any text, image, sticker, video, voice — it instantly appears anonymously on the board.\n• <b>Reply:</b> Simply <b>Reply</b> to any message. Author receives anonymous notification.\n• <b>Reactions:</b>\n  👍 <b>Like:</b> Gives author <b>+12.0 RUB</b>\n  👎 <b>Sage:</b> Imposes penalty <b>-5.5 RUB</b>\n• <code>/redact</code> — Delete your last post (as reply to it).\n• <code>/whisper &lt;text&gt;</code> — Send anonymous whisper to post author.\n• <code>/poll Topic | Opt 1 | Opt 2</code> — Create anonymous poll.\n• <code>/report</code> — Report spam, CP or wipe to moderators.\n• <code>/whois</code> (<code>/info</code>) — View post author metadata & stats (as reply).\n• <code>/getid</code> — Get media file_id or chat/user ID.\n• <code>/app</code> — Open official TGACH WebApp.\n• <code>/active</code> — View list of active users on current board.\n• <code>/threads</code> — List active discussions (for /thread/ board).\n• <code>/create &lt;title&gt;</code> / <code>/cancel</code> / <code>/leave</code> — Create, cancel or exit threads (/thread/)."
    ),
    "economy": (
        "💰 <b>Section: Economy, Casino, Items & Shekels</b>\n\nShekels (₪) are the board's currency for upgrades, gear, shopping and gambling:\n\n• <code>/wallet</code> — Balance, referral system and transaction history\n• <code>/bank</code> (<code>/deposit</code>, <code>/withdraw</code>) — <b>Abu's Safe & Bank:</b> 100% protection from /rob, deposits earn 0.5%-6.0% daily\n• <code>/items</code> (<code>/wiki</code>) — <b>Item & Set Encyclopedia:</b> Complete specs for weapons, clothes, sets & crates\n• <code>/wardrobe</code> (<code>/boutique</code>) — <b>Wardrobe & Boutique:</b> Equip and buy custom hats, coats, glasses & cosmetics\n• <code>/market</code> (<code>/sell</code>) — <b>P2P Flea Market:</b> Trade items, weapons and lootboxes with other anons\n• <code>/shop</code> — <b>Black Market:</b> Mute-Guns, Pepper Sprays, body armor, tin foil hats & bails\n• <code>/rates</code> (<code>/kurs</code>, <code>/price</code>) — Current exchange rates and Black Market prices\n• <code>/work</code> — Labor exchange: 15 professions with set collection, passive income & loot\n• <code>/pay &lt;id/reply&gt; &lt;amount&gt;</code> — Transfer shekels directly to another anon with 0% fee\n• <code>/ledger</code> — Full financial statement of all income, transfers, bets and penalties\n• <code>/airdrop</code> — Drop random cash prize for active thread participants\n• <code>/amulet</code> — Check status or equip Cyberchad Amulet (7-day protection)\n• <code>/casino</code> — Casino hub: <code>/slots</code>, <code>/coinflip</code>, <code>/blackjack</code>, <code>/rroulette</code>, <code>/ttt</code>, <code>/dice_duel</code>, <code>/duel_rr</code>\n• <code>/ttt &lt;bet&gt;</code> — ❌⭕ PvP Tic-Tac-Toe on shekels (60s turn timer)\n• <code>/dice_duel &lt;bet&gt;</code> — 🎲 PvP 2d6 Dice Duel on shekels (fair dice generator)\n• <code>/duel_rr &lt;bet&gt;</code> — 💀 PvP Russian Roulette (6 chambers, 1 bullet, loser muted 30 min)\n• <code>/lootbox</code> — Crates: Garbage Bag (150₪) and Golden Safe (500₪)\n• <code>/avatar</code> — RPG character card and equipped items\n• <code>/ach</code> (<code>/achievements</code>) — Hall of Achievements (12 trophies with shekel rewards)\n• <code>/drop &lt;amount&gt;</code> — Drop cash pack into thread on fastest reaction\n• <code>/daily</code> — Daily login bonus (+75 ₪ + streak)\n• <code>/top</code> (<code>/gtop</code>, <code>/global_top</code>) — Richest board whales and oligarchs"
    ),
    "media": (
        "🖼 <b>Section: Media, Invites, Banners & Demotivators</b>\n\n• <code>/banner</code> (<code>/gallery</code>) — <b>Interactive Banner Gallery:</b> 1657 arts and videos across 23 categories, A-Z and random sort, pagination.\n• <code>/random</code> (<code>/randpic</code>, <code>/randvid</code>) — Display random art or 1080p animated video loop from banner archive.\n• <code>/dem Title | Subtitle</code> — <b>Demotivator generator!</b> Reply to any photo to create authentic poster with black border.\n• <code>/invite_pic</code> — Graphic recruiting poster with QR code (7 visual styles: Cyberpunk, Demotivator, Matrix, Anime, etc.).\n• <code>/invite</code> — Text invite phrases to recruit new anons.\n• <code>/fap</code> (<code>/hent</code>, <code>/nsfw</code>) [N] — Random anime/hentai art (e.g. <code>/fap 5</code> for 5 pics).\n• <code>/loli</code> [N] — Safe lolicon / ecchi art.\n• <code>/roll</code> (<code>/dice</code>) — Roll random dice from 0 to 100.\n• <code>/roll100</code> (<code>/d100</code>) — 100-sided dice roll.\n• <code>/ruletka</code> — Teleport to random board thread."
    ),
    "ai": (
        "🧠 <b>Section: AI, Analytics, Generators & Posters</b>\n\n• <code>/stats_hub</code> (<code>/deck</code>) — <b>Main Analytics Console!</b> Real-time pulse with sparklines, poster menus & WebApp.\n• <code>/my_wrapped</code> (<code>/wrapped</code>) — <b>Personal 2ch Wrapped:</b> HD poster with personality archetype, chronotype, rivals & AI diagnosis.\n• <code>/economy_stats</code> (<code>/econ</code>) — HD chart of shadow economy, casino and heists.\n• <code>/pvp_stats</code> — HD chart of debuff wars, poop battles and armor defense.\n• <code>/drama_stats</code> — HD chart of sworn enemies, board toxicity and nocturnal psychosis.\n• <code>/memes_stats</code> — HD viral meme meter, AI tags and slang trends.\n• <code>/passport</code> (<code>/me</code>) / <code>/mystats</code> — Anon Passport & degradation card with rank, balance & items.\n• <code>/dossier</code> — Secret KGB file with charges and surveillance notes (self or reply).\n• <code>/summarize</code> — AI summary of last 50 thread posts.\n• <code>/roast</code> — Brutal AI roast of current discussions.\n• <code>/slop</code> (<code>/slop hide</code> / <code>/slop show</code>) — Toggle AI roasts and neural slop.\n• <code>/bugurt</code> — Authentic imageboard bugurt generator (text or reply).\n• <code>/psychiatry</code> — Punitive psychiatry journal: official diagnosis & haloperidol prescription.\n• <code>/abu_voice</code> — Text-to-speech voiceover by Abu from Dubai.\n• <code>/holiday</code> — Daily festive celebration and drinking pretext.\n• <code>/stats</code> / <code>/board_stats</code> — Activity graphs and detailed board metrics.\n• <code>/graph</code> — Visual 90-day post dynamics timeline.\n• <code>/tags</code> / <code>/wordcloud</code> — 24-hour trending topic & keyword cloud."
    ),
    "modes": (
        "🎭 <b>Section: Speech Modes (5 Minutes)</b>\n\n• 🌸 <code>/anime</code> — Kawaii anime style\n• 🇷🇺 <code>/zaputin</code> — Patriotic Z-mode\n• 🇺🇦 <code>/slavaukraine</code> — Ukrainian dialect\n• ⚔️ <code>/warhammer</code> — Warhammer 40k roleplay\n• 📜 <code>/imperial</code> — Tsarist Russian dialect\n• 👊 <code>/gopnik</code> — Street slang\n• 🧠 <code>/schizo</code> — Paranoid schizo theories\n• 🇵🇱 <code>/polish</code> — Polish dialect\n• 🐊 <code>/rus</code> — <b>Ancient Rus vs Lizards v6.0:</b> Prof. Bagirov lectures, mammoth cavalry raids & Baikal water\n• 🐒 <code>/abu</code> — Dvach creator Surzhyk\n• 🕶 <code>/matrix</code> — Neo & Matrix terminal\n• 📟 <code>/oldweb</code> — 56k dial-up, Web 1.0 & FIDO\n• ✡️ <code>/jewish</code> — Business & kosher talk\n• 🦅 <code>/america</code> — Freedom & capitalism\n• ⏹️ <code>/stop</code> — Stop active mode\n\n🐊 <b>Rus vs Lizards — interactive commands:</b>\n• 🎓 <code>/bagirov</code> — Prof. Bagirov lecture (Hyperborea MGU)\n• ⚔️ <code>/drocheslav</code> (<code>/raid</code>, <code>/mammoth</code>) — Drocheslav's mammoth cavalry raid\n• 🧬 <code>/yashchertest</code> (<code>/dna</code>) — Slavic bloodline DNA purity test\n• ⚖️ <code>/veche</code> — Novgorod Veche tribunal\n• 🌌 <code>/horoscope_rus</code> (<code>/chertog</code>) — Slavic-Aryan horoscope (Svarog's Halls)\n• 📜 <code>/slav_trade</code> (<code>/gramota</code>) — Novgorod merchants trade charter\n• 🚀 <code>/hyperborea</code> (<code>/vimana</code>) — Hyperborea chronicle (Vimanas vs Lizards)\n• ⚡ <code>/slav_curse</code> (<code>/anathema</code>) — Volkhv curse against lizard infiltrators"
    ),
    "actions": (
        "⚔️ <b>Section: Actions, Duels, Weapons & PvP (As Reply)</b>\n\n• <code>/shoot</code> — <b>Mute-Gun Shot:</b> Mute victim for 1 hour (requires Mute-Gun from /shop).\n• <code>/pepperspray</code> — <b>Pepper Spray:</b> Spray victim's eyes with caustic gas, applying debuff (requires /shop).\n• <code>/bribe</code> — <b>Bribe Officer:</b> Remove handcuffs and cancel mute immediately (requires Bribe from /shop).\n• <code>/cure</code> — <b>Aminazine:</b> Instantly wash away all debuffs (poop, vomit, curses, schizo).\n• <code>/rob</code> — <b>Robbery:</b> Steal 10-30% of target's shekel wallet.\n• <code>/shit</code> — Fling fresh feces at post author.\n• <code>/vomit</code> — Spew toxic vomit over opponent's post for humiliation.\n• <code>/curse</code> — Hex target with schizo speech transform.\n• <code>/partyvan</code> — Dispatch police van with sirens to jail target.\n• <code>/opushchenie</code> — Read verdict and degrade loser to bottom rank.\n• <code>/duel &lt;bet&gt;</code> — Shekel shootout duel (50/50 win chance).\n• <code>/accept</code> / <code>/decl</code> — Accept or decline an incoming duel challenge.\n• <code>/ttt &lt;bet&gt;</code> — PvP Tic-Tac-Toe duel on shekels (60s turn timer).\n• <code>/dice_duel &lt;bet&gt;</code> — 2d6 PvP Dice duel on shekels.\n• <code>/duel_rr &lt;bet&gt;</code> — Russian Roulette PvP duel (loser muted 30 min).\n• <code>/deanon</code> — Mock IP & geolocation spoofing lookup.\n• 🗳️ <code>/votemute</code> — <b>Community Vote / Schizo-Mute:</b> Put post up for vote. 5 votes in 10 min trigger <b>30-MIN HARD MUTE</b> (cannot be bribed off!).\n• 📋 <code>/dopros</code> — <b>Department K Interrogation</b> (self or reply). Pay 50₪ bribe, take 5th amendment, or snitch on neighbors!\n• 🪪 <code>/fine</code> — <b>Vigilante Fine (Reply):</b> Requires Vigilante ID from /shop. Fine target 15 ₪ once daily."
    ),
    "settings": (
        "⚙️ <b>Section: Settings, Filters & Personalization</b>\n\n• <code>/color</code> — Choose neon aura color & nickname badge.\n• <code>/slop</code> (<code>/slop hide</code> / <code>/slop show</code>) — Toggle AI roasts and neural slop.\n• <code>/nsfw</code> — Toggle automatic spoiler on all incoming media.\n• <code>/hide &lt;word&gt;</code> — Add word to personal blacklist (hidden posts).\n• <code>/togglegif</code> — Hide heavy GIFs to save mobile data.\n• <code>/token</code> — Get personal auth token for TGACH Web UI (tgach.top).\n• <code>/admin</code> — Board moderator panel (staff only)."
    ),
    "all": (
        "📋 <b>Complete Command Index:</b>\n\n<b>Chat:</b> /start, /help, /redact, /whisper, /poll, /report, /whois, /getid, /app, /active, /threads, /create, /cancel, /leave, /quote, /dice\n<b>Profile & Dossier:</b> /passport (/me, /profile), /my_wrapped (/wrapped), /mystats, /dossier, /inv, /wardrobe, /items (/wiki), /achievements (/ach), /amulet, /color\n<b>Analytics & Charts:</b> /stats_hub (/deck), /stats, /graph, /board_stats (/bstats), /global_top (/gtop), /economy_stats (/econ), /pvp_stats, /drama_stats, /memes_stats, /tags, /wordcloud\n<b>Economy & Casino:</b> /wallet, /bank, /deposit, /withdraw, /market, /sell, /my_lots, /work, /daily, /shop, /rates, /ledger, /pay, /airdrop, /top, /duel, /ttt, /dice_duel, /duel_rr, /drop, /casino, /lootbox\n<b>Media:</b> /banner, /random (/randpic, /randvid), /dem, /invite_pic, /invite, /fap, /loli, /roll, /roll100 (/d100), /ruletka\n<b>AI & Generators:</b> /summarize, /roast, /slop, /bugurt, /psychiatry, /abu_voice, /holiday\n<b>PvP & Actions (Reply):</b> /dossier, /rob, /shit, /curse, /partyvan, /deanon, /shoot, /pepperspray, /bribe, /cure, /vomit, /opushchenie, /votemute, /dopros, /fine, /accept, /decl\n<b>Settings:</b> /nsfw, /hide, /togglegif, /token, /slop, /color\n<b>Modes:</b> /anime, /zaputin, /slavaukraine, /warhammer, /imperial, /gopnik, /schizo, /polish, /rus, /abu, /matrix, /oldweb, /jewish, /america, /stop\n<b>Rus vs Lizards subcmds:</b> /bagirov, /drocheslav, /yashchertest, /veche, /horoscope_rus, /slav_trade, /hyperborea, /slav_curse\n<b>Boards:</b> /b/, /a/, /po/, /soc/, /sex/, /h/, /bunker/, /vg/, /v/, /tech/, /ai/, /wh40k/, /mu/, /tv/, /fit/, /sci/, /biz/, /news/, /fa/, /x/, /vt/, /au/, /me/, /int/, /meta/, /thread/"
    ),
    "boards": (
...
HELP_HUB_PAGES_JP = {
    "main": (
        "⚡ <b>TGACH /b/ — ヘルプ＆マニュアル</b>\n\n匿名画像掲示板へようこそ！下のボタンからカテゴリーを選択してください：\n\n• 💬 <b>チャット</b> — 投稿、返信、ささやき、削除、WebApp、スレッド機能\n• 💰 <b>経済</b> — シェケル、財布、仕事、闇市、銀行、装備＆アイテム図鑑\n• 🖼 <b>メディア＆デモ</b> — /dem 作成、QRポスター、1650+バナー、d100ダイス\n• 🧠 <b>AI＆分析</b> — 要約、ロースト、ブグルト、精神病棟、Abu音声、スロップ設定\n• 🎭 <b>会話モード</b> — 15種類以上の変身スタイル＆古代スラヴ戦士コマンド\n• ⚔️ <b>対戦・PvP</b> — 強盗、決闘、ミュート銃、催涙スプレー、糞投げ、保釈、逮捕\n• ⚙️ <b>設定</b> — NSFWフィルター、NGワード、ネオンオーラ、APIキー\n• 📋 <b>全コマンド</b> — ボットの全機能アルファベット順一覧\n• 🌐 <b>板・チャンネル</b> — 全掲示板、公式チャンネル、Webサイト＆サポート\n\n🌐 Web: <a href=\"https://tgach.top\">tgach.top</a> | 速報: <a href=\"https://t.me/tgach_bot\">t.me/tgach_bot</a> | アーカイブ: <a href=\"https://t.me/tgchan_archive\">t.me/tgchan_archive</a>"
    ),
    "chat": (
        "💬 <b>カテゴリー: チャット、投稿＆ナビゲーション</b>\n\n• <b>投稿:</b> テキストや画像を送ると匿名で即座に板に流れます。\n• <b>返信:</b> メッセージに <b>返信 (Reply)</b> してください。\n• <b>リアクション:</b> 👍 (+12 RUB), 👎 (-5.5 RUB)。\n• <code>/redact</code> — 自分の投稿を削除（返信で使用）。\n• <code>/whisper &lt;文&gt;</code> — 投稿者に秘密のささやきを送信。\n• <code>/poll 質問 | 選択肢1 | 選択肢2</code> — アンケート作成。\n• <code>/report</code> — スパムを通報。\n• <code>/whois</code> (<code>/info</code>) — 投稿者のメタデータ確認（返信）。\n• <code>/getid</code> — メディアの file_id や ID を取得。\n• <code>/app</code> — 公式 TGACH WebApp を起動。\n• <code>/active</code> — 板のアクティブアノン一覧。\n• <code>/threads</code> — スレッド一覧（/thread/ 板専用）。\n• <code>/create &lt;題名&gt;</code> / <code>/cancel</code> / <code>/leave</code> — スレッド作成・キャンセル・退出。"
    ),
    "economy": (
        "💰 <b>カテゴリー: 経済、カジノ、アイテム＆シェケル</b>\n\nシェケル (₪) は装備、買い物、カジノで使える板の主要通貨です：\n\n• <code>/wallet</code> — 残高確認、招待ボーナス、取引履歴\n• <code>/bank</code> (<code>/deposit</code>, <code>/withdraw</code>) — <b>アブの銀行＆金庫:</b> 強盗100%防止、日利0.5%〜6.0%の利息\n• <code>/items</code> (<code>/wiki</code>) — <b>アイテム・セット大百科:</b> 武器・衣装・セット効果・薬・箱の詳細スペック\n• <code>/wardrobe</code> (<code>/boutique</code>) — <b>ワードローブ＆ブティック:</b> 帽子・メガネ・衣装の試着と購入\n• <code>/market</code> (<code>/sell</code>) — <b>P2P 蚤の市:</b> アノン同士でのアイテム・武器・ガチャ箱売買\n• <code>/shop</code> — <b>闇ショップ:</b> ミュート銃、催涙スプレー、防弾チョッキ、アルミホイル、保釈金\n• <code>/rates</code> (<code>/kurs</code>) — 現在の為替相場と闇市価格表\n• <code>/work</code> — 労働市場: 15種類の職業、セット収集、不労所得、ドロップ\n• <code>/pay &lt;id/reply&gt; &lt;金額&gt;</code> — 他のアノンへ手数料無料でシェケル直接送金\n• <code>/ledger</code> — 財務諸表: 全取引、収入、ペナルティ履歴\n• <code>/airdrop</code> — スレッドのアノン全員へランダム賞金配布\n• <code>/amulet</code> — サイバーチャドのお守り装着（7日間完全保護）\n• <code>/casino</code> — カジノハブ: <code>/slots</code>, <code>/coinflip</code>, <code>/blackjack</code>, <code>/rroulette</code>, <code>/ttt</code>, <code>/dice_duel</code>, <code>/duel_rr</code>\n• <code>/ttt &lt;賭け金&gt;</code> — ❌⭕ 三目並べ PvP 決闘（60秒タイマー）\n• <code>/dice_duel &lt;賭け金&gt;</code> — 🎲 2d6 サイコロ PvP 決闘（公平ダイス生成）\n• <code>/duel_rr &lt;賭け金&gt;</code> — 💀 ロシアンルーレット PvP（敗者は30分ミュート）\n• <code>/lootbox</code> — ガチャ箱: ゴミ袋 (150₪) と 黄金金庫 (500₪)\n• <code>/avatar</code> — RPGキャラクターカードと装備一覧\n• <code>/ach</code> (<code>/achievements</code>) — 実績の殿堂（12種類のトロフィーと賞金）\n• <code>/drop &lt;金額&gt;</code> — スレにシェケル束を落とし早押し勝負\n• <code>/daily</code> — 毎日のログインボーナス (+75 ₪ + 連続ボーナス)\n• <code>/top</code> (<code>/gtop</code>, <code>/global_top</code>) — 板の大富豪・大物ランキング"
    ),
    "media": (
        "🖼 <b>カテゴリー: メディア、招待、バナー＆デモティベーター</b>\n\n• <code>/banner</code> (<code>/gallery</code>) — <b>インタラクティブバナーギャラリー:</b> 23カテゴリ、1657枚のアート＆動画、A-Z/ランダム表示、ページ送り。\n• <code>/random</code> (<code>/randpic</code>, <code>/randvid</code>) — コレクションからランダムなアートまたは1080pアニメ動画を表示。\n• <code>/dem タイトル | サブ</code> — <b>デモティベーター生成！</b> 画像に返信してクラシックな黒枠ポスターを作成。\n• <code>/invite_pic</code> — QRコード付き招待ポスター作成（サイバーパンク、マトリックスなど7種）。\n• <code>/invite</code> — アノン勧誘用テキストフレーズ。\n• <code>/fap</code> (<code>/hent</code>, <code>/nsfw</code>) [枚数] — ランダムアニメアート（例: <code>/fap 5</code> で5枚パック）。\n• <code>/loli</code> [枚数] — 安全なロリ／エッチアート。\n• <code>/roll</code> (<code>/dice</code>) — 0〜100 のダイスロール。\n• <code>/roll100</code> (<code>/d100</code>) — 100面ダイスロール。\n• <code>/ruletka</code> — ランダムなスレッドへジャンプ。"
    ),
    "ai": (
        "🧠 <b>カテゴリー: AI、分析、ジェネレーター＆ポスター</b>\n\n• <code>/stats_hub</code> (<code>/deck</code>) — <b>総合分析ダッシュボード！</b> スパークライン付きリアルタイム分析、ポスターメニュー、WebApp連携。\n• <code>/my_wrapped</code> (<code>/wrapped</code>) — <b>パーソナル 2ch Wrapped:</b> 性格アーキタイプ、睡眠型、ライバル、AI診断ポスター。\n• <code>/economy_stats</code> (<code>/econ</code>) — 経済・カジノ・強盗のHD統計スライス。\n• <code>/pvp_stats</code> — デバフ戦争、糞投げ、アルミホイル防御のHD統計。\n• <code>/drama_stats</code> — 宿敵マップ、板の毒性、深夜の精神状態分析。\n• <code>/memes_stats</code> — ミーム・AIタグ・スラングのトレンドメーター。\n• <code>/passport</code> (<code>/me</code>) / <code>/mystats</code> — アノンパスポートと堕落カード（階級・残高・装備）。\n• <code>/dossier</code> — KGB調書風ファイル（自分または相手に返信）。\n• <code>/summarize</code> — スレッド過去50件のAI要約。\n• <code>/roast</code> — 板の議論に対する辛口AIロースト。\n• <code>/slop</code> (<code>/slop hide</code> / <code>/slop show</code>) — AI煽り・スロップの表示／非表示切替。\n• <code>/bugurt</code> — 掲示板定番ブグルト（怒りのグリーンテキスト）生成。\n• <code>/psychiatry</code> — 懲罰的精神医学カルテ: 公式診断書とハロペリドール処方。\n• <code>/abu_voice</code> — ドバイのアブの声で文章を読み上げ。\n• <code>/holiday</code> — 今日の祝日と飲む口実。\n• <code>/stats</code> / <code>/board_stats</code> — 板のアクティビティグラフと詳細統計。\n• <code>/graph</code> — 90日間の投稿動向タイムライン。\n• <code>/tags</code> / <code>/wordcloud</code> — 24時間の注目トピック＆ワードクラウド。"
    ),
    "modes": (
        "🎭 <b>カテゴリー: 会話モード（5分間）</b>\n\n• 🌸 <code>/anime</code> — カワイイアニメ風\n• 🇷🇺 <code>/zaputin</code> — 愛国Zモード\n• 🇺🇦 <code>/slavaukraine</code> — ウクライナ風\n• ⚔️ <code>/warhammer</code> — WH40k風\n• 📜 <code>/imperial</code> — 帝政ロシア風\n• 👊 <code>/gopnik</code> — ヤンキー風\n• 🧠 <code>/schizo</code> — 統合失調症風\n• 🇵🇱 <code>/polish</code> — ポーランド風\n• 🐊 <code>/rus</code> — <b>古代スラヴ戦士 vs トカゲ星人 v6.0:</b> バギロフ教授講義・マンモス騎兵隊・バイカル聖水\n• 🐒 <code>/abu</code> — アブのドバイ弁\n• 🕶 <code>/matrix</code> — マトリックス端末風\n• 📟 <code>/oldweb</code> — ダイヤルアップ・Web 1.0・FIDO\n• ✡️ <code>/jewish</code> — ビジネス風\n• 🦅 <code>/america</code> — アメリカ・自由主義風\n• ⏹️ <code>/stop</code> — モード停止\n\n🐊 <b>スラヴ戦士 vs トカゲ — サブコマンド:</b>\n• 🎓 <code>/bagirov</code> — バギロフ教授の特別講義\n• ⚔️ <code>/drocheslav</code> (<code>/raid</code>, <code>/mammoth</code>) — マンモス騎兵隊の襲撃\n• 🧬 <code>/yashchertest</code> (<code>/dna</code>) — スラヴ血統DNAテスト\n• ⚖️ <code>/veche</code> — ノヴゴロド民会裁判\n• 🌌 <code>/horoscope_rus</code> (<code>/chertog</code>) — スラヴ星座占い\n• 📜 <code>/slav_trade</code> (<code>/gramota</code>) — ノヴゴロド商人の証書\n• 🚀 <code>/hyperborea</code> (<code>/vimana</code>) — ヒュペルボレア年代記\n• ⚡ <code>/slav_curse</code> (<code>/anathema</code>) — トカゲへの呪詛"
    ),
    "actions": (
        "⚔️ <b>カテゴリー: PvP、対戦、武器＆アクション（返信で使用）</b>\n\n• <code>/shoot</code> — <b>ミュート銃発射:</b> 相手を1時間ミュート（/shop のミュート銃が必要）。\n• <code>/pepperspray</code> — <b>催涙スプレー:</b> 相手の目を潰しデバフを付与（/shop が必要）。\n• <code>/bribe</code> — <b>賄賂を渡す:</b> 手錠を外しミュートを即時解除（/shop の賄賂が必要）。\n• <code>/cure</code> — <b>アミナジン服用:</b> 糞、嘔吐、呪い、シゾ等の全デバフを即時浄化。\n• <code>/rob</code> — <b>強盗:</b> 相手の財布から10-30%のシェケルを強奪。\n• <code>/shit</code> — 糞を投げつける。\n• <code>/vomit</code> — 相手の投稿に毒性のあるゲロを吐きかける。\n• <code>/curse</code> — 呪いをかけて相手の投稿を狂気スタイルに改変。\n• <code>/partyvan</code> — パトカーを呼んでアノンを投獄。\n• <code>/opushchenie</code> — 判決を読み上げ負け犬を最下層へ格下げ。\n• <code>/duel &lt;賭け金&gt;</code> — シェケル決闘銃撃戦（勝率50/50）。\n• <code>/accept</code> / <code>/decl</code> — 挑まれた決闘を受諾または拒否。\n• <code>/ttt &lt;賭け金&gt;</code> — 三目並べ PvP 決闘（60秒タイマー）。\n• <code>/dice_duel &lt;賭け金&gt;</code> — 2d6 サイコロ決闘。\n• <code>/duel_rr &lt;賭け金&gt;</code> — ロシアンルーレット（敗者は30分ミュート）。\n• <code>/deanon</code> — フェイクIP特定スプーフィング。\n• 🗳️ <code>/votemute</code> — <b>住民投票ミュート:</b> 10分以内に5票集まると <b>30分間の鉄壁ミュート</b>（賄賂解除不可！）。\n• 📋 <code>/dopros</code> — <b>K課の尋問</b>（自分または相手）。50₪の賄賂、黙秘権、密告から選択！\n• 🪪 <code>/fine</code> — <b>自警団の罰金 (Reply):</b> 自警団員証が必要。違反者に15₪の罰金を科す。"
    ),
    "settings": (
        "⚙️ <b>カテゴリー: 設定、フィルター＆個人設定</b>\n\n• <code>/color</code> — ネオンオーラの色とニックネームバッジを選択。\n• <code>/slop</code> (<code>/slop hide</code> / <code>/slop show</code>) — AIロースト・スロップの表示／非表示切替。\n• <code>/nsfw</code> — 受信メディアのNSFW自動スポイラー切替。\n• <code>/hide &lt;単語&gt;</code> — NGワード追加（該当投稿を非表示）。\n• <code>/togglegif</code> — 通信量節約のため重いGIFを非表示。\n• <code>/token</code> — Web APIログイン用トークン発行 (tgach.top)。\n• <code>/admin</code> — モデレーターパネル（管理者専用）。"
    ),
    "all": (
        "📋 <b>全コマンド一覧:</b>\n\n<b>チャット:</b> /start, /help, /redact, /whisper, /poll, /report, /whois, /getid, /app, /active, /threads, /create, /cancel, /leave, /quote, /dice\n<b>プロフィール＆調書:</b> /passport (/me), /my_wrapped (/wrapped), /mystats, /dossier, /inv, /wardrobe, /items (/wiki), /achievements (/ach), /amulet, /color\n<b>分析＆グラフ:</b> /stats_hub (/deck), /stats, /graph, /board_stats (/bstats), /global_top (/gtop), /economy_stats (/econ), /pvp_stats, /drama_stats, /memes_stats, /tags, /wordcloud\n<b>経済＆カジノ:</b> /wallet, /bank, /deposit, /withdraw, /market, /sell, /my_lots, /work, /daily, /shop, /rates, /ledger, /pay, /airdrop, /top, /duel, /ttt, /dice_duel, /duel_rr, /drop, /casino, /lootbox\n<b>メディア:</b> /banner, /random (/randpic, /randvid), /dem, /invite_pic, /invite, /fap, /loli, /roll, /roll100 (/d100), /ruletka\n<b>AI＆生成:</b> /summarize, /roast, /slop, /bugurt, /psychiatry, /abu_voice, /holiday\n<b>対戦＆アクション (Reply):</b> /dossier, /rob, /shit, /curse, /partyvan, /deanon, /shoot, /pepperspray, /bribe, /cure, /vomit, /opushchenie, /votemute, /dopros, /fine, /accept, /decl\n<b>設定:</b> /nsfw, /hide, /togglegif, /token, /slop, /color\n<b>モード:</b> /anime, /zaputin, /slavaukraine, /warhammer, /imperial, /gopnik, /schizo, /polish, /rus, /abu, /matrix, /oldweb, /jewish, /america, /stop\n<b>スラヴ戦士サブコマンド:</b> /bagirov, /drocheslav, /yashchertest, /veche, /horoscope_rus, /slav_trade, /hyperborea, /slav_curse\n<b>板:</b> /b/, /a/, /po/, /soc/, /sex/, /h/, /bunker/, /vg/, /v/, /tech/, /ai/, /wh40k/, /mu/, /tv/, /fit/, /sci/, /biz/, /news/, /fa/, /x/, /vt/, /au/, /me/, /int/, /meta/, /thread/"
    ),
    "boards": (
