...
HELP_HUB_PAGES_RU = {
    ...
    "economy": (
        ...
        "Шекели (₪ / ₽) — внутрибордовая валюта для покупки артефактов, ставок в костях и доминирования в топе.\n\n"
        "• <code>/wallet</code> (<code>/кошелек</code>, <code>/баланс</code>) — Баланс, история операций, рефералы и вывод.\n"
        "• <code>/rates</code> (<code>/kurs</code>, <code>/прайс</code>, <code>/цены</code>) — <b>Прайс-лист активности и курсы TGACH PAY / EXCHANGE.</b>\n"
