...
HELP_HUB_PAGES_RU = {
    ...
    "economy": (
        ...
        "Шекели (₪ / ₽) — внутрибордовая валюта для покупки артефактов, ставок в казино и доминирования в топе.\n\n"
        "• <code>/wallet</code> (<code>/кошелек</code>, <code>/баланс</code>) — Баланс, история операций, рефералы и вывод.\n"
        "• <code>/casino</code> (<code>/казино</code>) — <b>Подпольное Казино Тгача:</b> слоты, монетка, блэкджек, рулетка.\n"
        "• <code>/slots &lt;ставка&gt;</code> (<code>/777</code>, <code>/казик</code>) — <b>Слоты 777:</b> Джекпот x50, Бриллианты x15, Клубнички x5.\n"
        "• <code>/coinflip &lt;ставка&gt; [орел|решка]</code> (<code>/монетка</code>) — Бросок монетки 50/50 (выплата x1.95).\n"
        "• <code>/blackjack &lt;ставка&gt;</code> (<code>/bj</code>, <code>/21</code>, <code>/очко</code>) — Карточный Блэкджек против дилера (x2.0 / x2.5).\n"
        "• <code>/rroulette &lt;ставка&gt;</code> (<code>/гусар</code>) — Русская рулетка: выживание со стриками до x5.0!\n"
        "• <code>/drop &lt;сумма&gt;</code> (<code>/чек</code>, <code>/дроп</code>) — <b>Дроп шекелей в тред на реакцию:</b> первый нажавший забирает куш!\n"
        "• <code>/work</code> (<code>/earn</code>, <code>/работа</code>) — Пойти на заработки (бутылки, дворник, капча, шпионаж).\n"
        "• <code>/daily</code> (<code>/bonus</code>, <code>/ежедневно</code>) — Ежедневный бонус (+75 ₪ + стрик до +70 ₪).\n"
        "• <code>/dice &lt;ставка&gt;</code> (<code>/кости</code>) — Подпольные кости: удвоение ставки (x2) при ролле ≥55, x4 при 100.\n"
        "• <code>/shop</code> (<code>/market</code>, <code>/магазин</code>) — Теневой Чёрный Рынок: Заточка, Мут-Ган, Щит, Пативэн, Мегафон.\n"
        "• <code>/gtop</code> (<code>/leaders</code>, <code>/богачи</code>) — Рейтинг богатейших олигархов борды."
    ),
    "media": (
