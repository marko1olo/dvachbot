...
HELP_TEXT_COMMANDS = [
    (
        ...
        "/invite — Пригласить анонов (текст)\n"
        "/invite_pic — Картинка-инвайт с QR-кодом\n"
        "/dem заголовок | подпись — Демотиватор (реплай на фото)\n"
