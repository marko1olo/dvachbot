...
HELP_HUB_PAGES_RU = {
    ...
    "economy": (
        ...
        "• <code>/work</code> — Биржа труда: 7 вакансий со сбором сетов и лута\n"
        "• <code>/casino</code> — Казино: <code>/slots</code>, <code>/coinflip</code>, <code>/blackjack</code>, <code>/rroulette</code>\n"
