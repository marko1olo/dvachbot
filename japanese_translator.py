...
JAPANESE_WORD_REPLACEMENTS = {
    ...
    "кто": "誰", "кого": "誰に", "каво": ['誰に', '誰'], "шо": ["何", "何が"], "что": ["何", "何が"], "че": ["何", "何が"], "чё": ["何", "何が"], "где": ['どこ', '所で'], "когда": ['いつ', '時に'], "почему": ['なぜ', 'どうして'], "как": "どう", "какой": "どの", "сколько": "いくつ", "чей": "誰の",
    ...
    "фейл": ["悪い", "ダメ", "良くない"],
    "фэйл": ["悪い", "ダメ", "良くない"],
    "очень": ["とても", "すごく", "めっちゃ", "超"], "анон": ["人", "人間"], "тгачер": ["人", "人間"], "двачер": ['人', '人間', '2chの住民'],
    ...
    "картинка": "画像は", "пикча": "画像は", "видео": "動画は", "видос": "動画は", "ссылка": 'リンク', "сайт": ['サイトは', 'サイト'],
    "правда": ['本当は', 'マジ', 'ガチ', '本当'], "фейк": "偽", "инфа": "情報", "пруф": '証拠',
    ...
    "милфа": "MILFは",
    "милфу": "MILFは",
    "куколд": ['寝取られ', '寝取られ野郎', 'NTR趣味', 'ネトラレ男', 'オメガ雄'],
    "куколда": ['寝取られ', '寝取られ野郎の', 'NTR男の', 'NTR男を'],
    "форс": "ゴリ押し",
    "форсят": "ゴリ押しする",
    "хз": ['さあ', '知らない', '分かんない'],
    "имхо": ['私見', '個人的には'],
    ...
    "пидараса": "ホモ野郎の",
    "пидарас": "ホモ野郎は",
    "долбоебы": ['大馬鹿ども', '馬鹿共', 'アホども', '馬鹿野郎ども', 'トンチキども'],
    "долбоебу": ['大馬鹿どの', 'バカ'],
    "еблана": "バカの",
    "мудака": "ろくでなしの",
    "мудаку": "ろくでなしの",
...
# --- Современный интернет-сленг, архетипы и субкультуры ---
    ...
    "штрих": ['ヤンキー', 'DQN', '不良', '奴'],
    "думер": ['鬱ニート', '引きこもり', '絶望系', 'ドゥーマー'],
    "омега": ['陰キャ', '負け組', '底辺', 'チー牛'],
    "альфа": ['陽キャ', '勝ち組', 'オラオラ系', 'アルファ', 'アルファ雄'],
    "база": ['覇権', '真理', '基礎', 'それな', '正論', 'ベース', '基本'],
    "базированный":['確信した', '真理を知る者', 'ベースド', '天才的な', '達識'],
    "вайб":['エモい雰囲気', 'ノリ', 'バイブス', 'オーラ', '雰囲気'],
    "кринж":['イタい', 'ドン引き', '寒気', '黒歴史', 'キモい', '痛い'],
    "токсик":['害悪', '民度低い', '有毒', 'クソリプ野郎', '有害な', '毒のある', '毒'],
    "душный":['めんどくさい', '重い', 'うざい', '空気読めない', '面倒くさい', '息苦しい'],
    "чилл":['まったり', 'のんびり', 'チル', 'リラックス'],
    "флексить":['イキる', 'マウントをとる', '自慢する', '見せびらかす'],
    "деанон": ['特定', '身バレ', '個人情報特定'],
    "слив":['晒し', 'リーク', '暴露', '情報漏洩', 'ネタバレ'],
    "подпивас":['飲んだくれ', '酒クズ', 'アル中'],
    "чмо":['クズ', 'ゴミ', 'ザコ', 'カス', 'クソ虫', 'ダサい奴', 'キモい奴'],
    "пиздабол":["嘘つき", "ほら吹き", "虚言癖"],
    # --- Отношения, девиации и телесный низ ---
    "куколду": ['寝取られ野郎に', 'NTR男に'],
    ...
    "пукнул":['屁をこいた', 'ガスを噴射した', 'オナラした'],
    "баребухи":['クソ玉', 'ウンチの欠片', 'カス'],
    "малафья":["白濁液", "ザーメン", "カルピス", "愛の蜜"],
    "пробка": ['アナルプラグ', '栓', '開発グッズ', 'プラグ'],
    "анальный":['アナルの', 'ケツの', '後孔の', '肛門の'],
    "подмыться":['局部を洗う', 'シャワー浴びる', '身を清める', '洗う'],
    "подмылся":['局部を洗った', 'シャワー浴びた', '洗った'],
    "срач":['炎上', 'レスバ', '喧嘩', 'ネットのゴミ溜め'],
    "туалет": ["トイレ", "便所", "WC", "汚物入れ"],
    "сортир": ["便所", "クソ溜め", "パラシャ"],
    "мыться":['風呂に入る', '体を洗う', '沐浴する', '体洗う'],
    "душ": ["シャワー", "水浴び"],
    ...
    "сидишь": ['引きこもってる', '座ってるか', '座ってる'],
    "сидят":['引きこもってる', '溜まってる', '座ってる'],
    "пишу": ['書いてる', 'レスしてる', 'タイピングしてる'],
    "пишешь":['書いてる', 'レスしてるか', '書いてるか'],
    "пишут": ['書き込んでる', 'レスしてる', '書いてる'],
    ...
    "заводом":['ブラック企業で', '労働キャンプで', '工場で'],
    "заводе": ['工場で', 'ブラック企業で', '工場に'],
    "ипотека": ["住宅ローン", "借金地獄", "奴隷契約"],
    "кредит":['借金', 'ローン', '負債'],
    "падик":["路地裏", "ヤンキーの溜まり場", "薄暗い階段"],
    "падика":['路地裏の', '階段の'],
    "хрущевка":['ボロアパート', '団地', 'スラムの箱'],
    "хрущевки": ['ボロアパート群', 'スラム街', '団地'],
    "космос": ['宇宙', '銀河', '星海'],
    "тайга":['大森林', 'タイガ', '未開の森'],
    "солнце": ['太陽', '日輪', 'お天道様', 'サン'],
    "луна": ['月', '月明かり', '夜のランプ', 'ムーン'],
    "дождь":['雨', '涙の雨', 'スコール', 'レイン'],
    # --- Политика, Война, Z-режим и Гримдарк ---
    "иноагент":["スパイ", "反逆者", "裏切り者", "異端者"],
    "либерал":['リベラルカス', '売国奴', '西洋の犬', 'リベラル', 'リベカス', 'リベラル野郎'],
    "скрепы":['伝統', '絆', '古き良き掟', '神聖なる教え', '精神的な絆(笑)', '伝統的価値観(笑)'],
    "гойда":['突撃！', 'バンザイ！', '玉砕！', 'ウラー！', 'ゴイダ！'],
    "ересь": ["異端", "禁忌", "タブー", "冒涜"],
    ...
    "змея": "ヘビ", "уж": ['ヘビ', 'もう'], "гадюка": "毒蛇", "кобра": "コブラ", "питон": "ニシキヘビ", "роса": "露", "град": "雹",
    "лед": "氷", "гром": "雷", "ураган": "ハリケーン", "землетрясение": "地震", "вулкан": "火山",

    # === Одежда ===
    "лифчик": "ブラ", "носок": "靴下", "чулок": "ストッキング", "пиджак": "ジャケット", "рубашка": 'シャツ',
    "брюки": "ズボン", "юбка": 'スカート', "платье": ['ワンピース', 'ドレス'], "халат": "ローブ", "шорты": "ショートパンツ",
    "джинсы": 'ジーンズ', "колготки": "タイツ", "футболка": 'Tシャツ', "свитер": "セーター", "кофта": ['カーディガン', 'セーター', 'トレーナー'],
    "куртка": 'ジャケット', "пальто": 'コート', "плащ": "マント", "шарф": "マフラー", "перчатки": "手袋",
    "варежки": "ミトン", "шапка": '帽子', "шляпа": "帽子", "кепка": "キャップ", "панама": "ハット",
    "маска": "マスク", "очки": ['メガネ', '眼鏡'], "темные очки": "サングラス",
    ...
    "джем": "ジャム", "компот": "コンポート", "квас": "クワス", "лимонад": "レモネード", "сок": ['ジュース', '果汁'],
    ...
    "кассир": "レジ係", "официант": "ウェイター", "повар": ['シェフ', '料理人'], "пекарь": "パン屋", "садовник": "庭師",
    "охотник": "ハンター", "рыбак": "漁師", "моряк": "船乗り", "пилот": "パイロット", "капитан": "船長",
    "офицер": "将校", "генерал": "将軍", "дрель": "ドリル", "молоток": "ハンマー", "пила": ['ノコギリ', '飲んだ'],
    ...
    "делаю": ['してる', 'する', 'やってる'], "делает": "してる", "делаем": "してる", "сделать": "する", "сделали": 'した',
...
"кукарекать": "喚く", "кукарекаешь": "喚いてる", "кукарекает": "喚いてる",
    ...
    "угар": "爆笑", "ржака": "草", "хайп": "バズ", "лайк": "いいね", "эмодзи": "絵文字",
    "реакция": "反応", "реакцию": "反応を", "зашквар": "ドン引き", "гоу": ['行こ', '行こうぜ', 'やろう'],     "чувак": "お前", "ананас": "パイナップル", "анонче": "名無し", "анончик": "名無し君",
    ...
    "улыбка": "笑顔", "танец": "ダンス", "пение": ['歌', 'シンギング'], "красота": "美しさ", "уродство": "醜さ", "ревность": '嫉妬',
    ...
    "вейп": "Vape", "наркотик": "薬物", "спиздил": ['パクった', '盗んだ'], "украл": "盗んだ", "заткнись": ['黙れ', 'うるさい', 'だまれクソ'], "ебало": ['ツラ', '顔面', 'クソ面'],
    "рожа": "顔", "тикток": "TikTok", "ютуб": "YouTube", "телега": "テレグラム",     "вк": "VK", "инста": "インスタ", "кружок": "動画メッセージ",     "направо": "右へ", "налево": "左へ", "вверх": "上へ", "вниз": "下へ", "вперёд": "前へ", "назад": "後ろへ",
    "везде": "どこでも", "нигде": "どこにも", "теперь": "今", "раньше": "以前", "позже": "後で", "рано": "早く",
    "поздно": "遅く", "вероятно": "おそらく", "наверное": ['たぶん', '多分', 'だろう'], "очевидно": '明らかに', "по-видимому": "どうやら",
    "якобы": "〜らしい", "оказывается": "実は", "выходит": "つまり", "кажется": "みたい", "однако": "しかし",
    "впрочем": "まあ", "кстати": ['ちなみに', 'ところで'], "тем не менее": "それでも", "к счастью": "幸いなことに",
    ...
    "безусловно": "無条件で", "даже": 'さえ', "едва": "かろうじて", "едва ли": "ほとんど〜ない",
    "вряд ли": "たぶん〜ない", "вот-вот": "もうすぐ", "чуть": "少し", "чуть ли не": "ほとんど", "ай": "痛っ",
    "ох": "あっ", "ура": "やった", "увы": "ああ", "боже": "神よ", "господи": "主よ", "ну": ['ええと', 'あの'], "вот": "ほら",
    "вон": "あそこ", "эй": ['おい', 'ねえ'], "помощь": "助け", "погодите": "待って",     "пон": "りょ", "лан": "おけ", "лс": "DM", "чс": "ブロ", "кста": "てか", "чиназес": "最高", "сас": "怪しい",
    "тапать": "タップする", "заскамил": ['詐欺った', '詐欺した'], "дединсайд": "病み期", "позер": "にわか", "симпл димпл": "プッシュポップ",
    "поп ит": "プッシュポップ", "ауф": "オラァ", "треш": "ヤバい", "туса": ['飲み会', '集まり', 'パーティー'], "вписка": "宅飲み",
    ...
    "шалава": "ビッチ", "манда": "マンコ", "елда": "デカチン", "дрочила": ['シコザル', 'シコった', 'オナった'], "дамаг": "ダメ", "хил": "回復",
    ...
    "репост": "RT", "комментарий": "コメント", "гифка": "GIF", "неудача": "失敗", "сложно": ['難しい', '難しく'], "важно": "重要",
    ...
    "тянку": "女を", "тянке": "女に", "тянкой": "女で",     "бати": "親父の", "бате": "親父に", "батей": "親父で",     "падике": "路地裏で", "спермой": "ザーメンで", "попе": ['ケツに', 'お尻'], "попу": ['ケツを', 'お尻を', 'お尻'], "попой": ['ケツで', 'お尻で'],
    "пузо": "腹", "пуза": "腹の", "живот": "腹", "ноги": ['足', 'レッグ'], "ногами": "足で", "руки": ['手', '腕', 'アーム'], "руками": "手で",
    "глаза": ['目', 'アイ'], "глаз": ['目の', '目', 'アイ'], "глазами": "目で", "уши": ['耳', 'イヤー'], "ссылку": "リンクを",
    "ссылки": "リンク", "сайта": "サイトの", "комменты": "コメント",
"пруфы": "証拠", "пруфов": "証拠の", "больница": ['病院', 'ホスピタル'], "больнице": "病院で", "больницу": "病院へ",
    "врач": ['医者', 'ドクター'], "врача": ['医者を', '医者', 'ドクター'], "аптека": "薬局", "таблетки": "薬", "таблетками": "薬で", "лекарство": "薬",
    "машину": "車を", "машины": ['車の', '車', '自動車', 'カー'], "машиной": "車で", "автобус": ['バス', '乗合車'], "автобусе": "バスで", "такси": "タクシー",
    "дорога": "道", "дороге": "道で", "батарейка": "バッテリー", "экране": "画面に",
    "клавиатура": "キーボード", "клавиатуре": "キーボードで", "кнопку": "ボタンを",
    "свидание": 'デート', "свидании": "デートで", "отношения": '関係', "отношениях": "関係で", "шлюхой": "ビッチで",
"девственница": '処女', "альфачу": "陽キャに", "альфачом": "陽キャで", "инцелов": "童貞の",

    # === Специфические слова (из Гопника, Тгача, и т.д.) ===
"аутист": "ガイジ", "хлороформ": "クロロホルム",     "заложник": "人質", "одиночество": '孤独', "триада": "マフィア", "кончил": ['イッた', 'イった', '射精した', '抜いた', '逝った'], "такса": "ダックスフント",
    "огурец": "キュウリ", "сандалии": "サンダル", "рекламил": "宣伝した", "очкошников": "ビビリ", "параша": "クソ",
"съебутся": "逃げる", "сьебутся": "逃げる", "съебался": "逃げた", "крестный ход": "巡礼",
    "обществознание": "社会学", "контрольная": "テスト", "двощи": "2ch", "тытруба": "YouTube", "видосик": "動画",
    "динамики": "スピーカー", "голова": ['頭', 'ヘッド'], "мозг": '脳', "пасха": "イースター", "иисус": "イエス",
    "куличи": "パン", "кулич": "パン", "совок": "ソ連", "ссср": "ソ連",     "гагарин": "ガガーリン", "американцы": "アメリカ人", "американцев": "アメリカ人を", "кубрик": "キューブリック",
    "нейрослоп": "AI生成", "кальянщица": "水タバコ女", "онлифанщица": "OF女子", "алко": "酒", "наркота": "薬物",
    "антидепрессанты": "抗うつ薬", "наркоманство": "ヤク中", "блевать": "吐く", "комбикорм": "飼料", "мясо": ['肉', 'ミート'],
    ...
    "терпила": "負け犬", "батя": "親父", "мать": ['おかん', '母', '母親'], "диван": "ソファ", "прогиб": "スープレックス", "нос": ['鼻', 'ノーズ'],
    "трудовик": "技術の先生", "мразь": ['クズ', '下衆野郎'], "рецепт": "レシピ", "бревно": "丸太", "дуров": "ドゥーロフ",
    ...
    "доброжелателен": "親切", "заменили": "交換した", "дали": ['あげた', '与えた'], "гордиться": "誇る", "тгач": "掲示板",
    "тгачь": "掲示板", "хуже": "悪い", "запретили": "禁止した", "шествия": "デモ", "воскресению": "日曜日に",
    "русских": "ロシア人の", "лиц": "顔の", "традицию": "伝統を", "исламистам": "イスラム教徒に",
    ...
    "фанатизм": "狂信", "серых": "灰色の", "сынчела": "息子", "ублюдок": ['クソ野郎', 'ろくでなし'], "завали": ['黙れ', 'うるさい', 'だまれクソ', 'くたばれ！'], "хряк": "豚",
    ...
    "забила": "無視した", "уголовное": "刑事の", "дело": "事件", "оскорбления": "侮辱",     "верующих": "信者の", "колонии": "刑務所の", "поздняков": "ポズドニャコフ", "отвратительной": "気持ち悪い",
    "бумага": "紙", "горит": "燃えてる", "стоимость": "価格", "вошел": "入った", "залив": "湾", "блокаду": "封鎖",
    "пролива": "海峡の", "выписан": "退院した", "москва": "モスクワ", "ребятки": "お前ら", "очко": ['ケツ穴', '肛門'],
    "анус": ['アヌス', '肛門'], "пердак": "ケツ", "пленник": "捕虜", "спамил": "連投した", "дно": '底',
    "россии": "ロシアの", "россию": "ロシアを", "власть": "権力", "митинг": 'デモ', "молитва": "祈り", "угроза": "脅威",
    "препод": "教授", "слезы": "涙", "милосердие": "慈悲", "бомжи": "ホームレス", "полет": "飛行",
    ...
    "огонь": "火", "байден": "バイデン", "экономика": '経済', "сон": "睡眠", "приснился": "夢を見た",
    "игры": "ゲーム", "комп": "パソコン", "мамка": "おかん", "конча": ['精液', 'ザーメン'], "забанили": "BANされた",
    "модератор": "モデレーター", "школьник": "ガキ", "школота": "ガキ共", "мем": 'ミーム',
    "мемы": "ミーム", "фотка": "写真", "фото": ['写真', 'フォト'], "телефон": ['電話', 'スマホ', 'ケータイ'], "мобила": "スマホ", "лицо": '顔', "жена": "妻", "муж": "夫", "измена": "浮気", "развод": "離婚", "налоги": "税金",
    "зарплата": '給料', "пенсия": "年金", "телевизор": "テレビ", "мент": ['サツ', '警察', '警官'], "менты": "ポリ公", "полиция": '警察',
    "пиво": ['ビール', '麦酒'], "плакать": "泣く", "боль": "痛み", "смех": "笑い", "смеяться": "笑う", "кроссовки": 'スニーカー',
    "трусы": "パンツ", "качалка": "ジム", "насрал": "クソした", "пернул": "屁こいた", "подрочил": "シコった",
    "жирный": "デブ", "лысый": "ハゲ", "курьер": "配達員", "аноним": "名無し", "анонимус": "名無し", "анонимы": "名無し共", "анонимов": "名無し共を",
    "битард": ['陰キャ', 'B板の住民', 'B板のガイジ'], "битарды": "陰キャ共", "мусор": "ゴミ", "мусора": "サツ", "мусоров": "サツを",
    ...
    "машина": ["車", "自動車", "カー"], "телефоны": ["電話", "スマホ", "ケータイ"],
...
"повара": ["料理人", "シェフ"],
    ...
    "президент": "大統領", "правительство": "政府",     "закон": "法律", "правило": "ルール", "армия": '軍隊', "народ": "国民",
    "выборы": "選挙", "голос": "票", "политика": "政治",
    "революция": "革命",     "свобода": '自由', "равенство": "平等", "справедливость": '正義',
    "капитализм": "資本主義", "коммунизм": "共産主義",     "украина": "ウクライナ", "беларусь": "ベラルーシ", "казахстан": "カザフスタン",
...
"чечик": "男",
    ...
    "решать": "決める", "решаю": "決めてる", "решает": "決めてる", "решила": "決めた",
    ...
    "смотреть": "見る", "смотрю": "見てる", "смотрит": "見てる",     "слушать": "聞く", "слушаю": "聞いてる", "слушает": "聞いてる",     "кричать": "叫ぶ", "кричу": "叫んでる", "кричит": "叫んでる", "кричи": "叫べ",
...
"куда": ["所へ", "方向に"], "откуда": "から", "зачем": "なぜ", "ли": "かどうか",
    "бы": ["だろう", "でしょう"], "ведь": "だって", "мол": "と言って", "дескать": "と言って", "только": "だけ", "лишь": "だけ", "неужели": "まさか", "разве": "まさか",
    "стояк": "勃起", "эрекция": "勃起", "хуй": ['ちんこ', 'ペニス', '陰茎', 'ちんぽ', '野郎', 'チソポ'], "пизда": ['まんこ', '膣', 'ワギナ', '女性器', 'プッシー', 'やばい', '最悪だ'],     "грудь": ["おっぱい", "胸"], "сиськи": ['おっぱい', '胸'], "писька": ["まんこ", "膣", "ワギナ"], "хер": ["ちんこ", "ペニス", "陰茎"], "ебать": ['セックスする', 'ヤる', 'ファックする', '気が狂う', 'クソ', 'クソ！', 'チクショウ！', 'くたばれ！', 'ちくしょう', 'マジか', '信じられない'],
    "ебануться": ['頭がおかしくなる', '狂う', '気が狂う'], "ебанутый": ["頭がおかしい", "狂ってる"], "ебанутая": ["頭がおかしい", "狂ってる"], "ебанутые": ["頭がおかしい", "狂ってる"],
    ...
    "меньше": "もっと少ない", "половина": "半分", "треть": "三分の一", "четверть": "四分の一", "целый": "全体の",     "первый": "最初", "второй": "二番目", "третий": "三番目", "четвертый": "四番目", "пятый": "五番目",
    ...
    "понял": ['分かった', 'なるほど', '了解'], "поняла": "分かった", "поняли": "分かった",
    "ебал": "クソだ", "ебала": "クソだ", "ебали": "クソだ", "кончила": ["イった", "射精した", "抜いた", "逝った"], "кончили": ["イった", "射精した", "抜いた", "逝った"], "кончит": ["イく", "射精する", "抜く", "逝く"],
    ...
    "дрочил": ["シコった", "オナった"], "дрочили": ["シコった", "オナった"], "дрочи": ["シコれ", "オナれ"],
    ...
    "хорошая": "良い", "хорошее": "良い", "хорошие": "良い",     "плохая": "悪い", "плохое": "悪い", "плохие": "悪い",     "красивая": "美しい", "красивое": "美しい", "красивые": "美しい", "красиво": "美しく",
...
"умно": "賢く",
    ...
    "легкая": "簡単な", "легкое": "簡単な", "легкие": ['簡単な', '肺'], "легко": "簡単に",
    "сложная": "難しい", "сложное": "難しい", "сложные": "難しい", "руский": ["ホモ", "おかま", "ゲイ", "ホモ野郎"],
    "громкая": "うるさい", "громкое": "うるさい", "громкие": "うるさい", "громко": "うるさく", "русский": ["ホモ", "おかま", "ゲイ", "ホモ野郎"],
    "тихая": "静かな", "тихое": "静かな", "тихие": "静かな", "тихо": "静かに", "путин": ["ホモ", "おかま", "ゲイ", "ホモ野郎"], "ватник": ['ホモ', 'おかま', 'ゲイ', 'ホモ野郎', '愛国ガイジ'],
"вагинальный": ["ヴァギナの", "膣の"], "оральный": ["オーラルの", "口の"], "генитальный": ["ジェニタルの", "生殖器の"], "сексуальный": ["性的な", "セクシーな"], "эротический": ["エロティックな", "エロい"], "порнографический": ["ポルノの", "エロい"],
    # --- Мат и грубости (Swear & Rude words) ---
    "блять": ["くそ", "ちくしょう", "畜生", "チクショウ！"], "блядь": ["くそ", "ちくしょう", "畜生", "チクショウ！"], "жопой": ["ケツで", "けつで"], "попкой": "お尻で", "сракой": "お尻で", "пиздос": ["やばい", "マジかよ", "最悪だ", "終わってる", "チクショウ！", "やばい", "最悪だ"],
...
"залупа": ["ちんこ", "ちんぽ", "野郎", "チソポ"], "хуи": "ディックス", "пиздеж": ["デタラメ", "出鱈目", "嘘八百", "嘘八百", "たわごと"], "пиздёж": ["デタラメ", "出鱈目", "嘘八百", "嘘八百", "たわごと"], "пиздежу": ["デタラメ", "出鱈目", "嘘八百", "嘘八百", "たわごと"], "пиздёжа": ["デタラメ", "出鱈目", "嘘八百", "嘘八百", "たわごと"],
    "пидор": ["ホモ", "おかま", "ゲイ", "ホモ野郎"], "пидоры": ["ホモ", "おかま", "ゲイ", "ホモ野郎"], "пидору": ["ホモ", "おかま", "ゲイ", "ホモ野郎"], "пидорам": ["ホモ", "おかま", "ゲイ", "ホモ野郎"], "пидором": ["ホモで", "おかまで", "ゲイで", "ホモ野郎で"],
    "сука": ["雌犬", "あばずれ", "この野郎", "やばい", "最悪だ"], "сучара": ["雌犬", "あばずれ", "この野郎", "やばい", "最悪だ"], "сисяры": "おっぱい", "сиси": "おっぱい", "сисяндры": "おっぱい", "суки": ["雌犬", "あばずれ", "この野郎"], "сучары": ["雌犬", "あばずれ", "この野郎"], "сиська": "おっぱい", "сук": ["雌犬", "あばずれ", "この野郎"],
    "говно": ["うんこ", "クソ", "糞"], "гавно": ["うんこ", "クソ", "糞"], "говнище": ["うんこ", "クソ", "糞"], "гавнище": ["うんこ", "クソ", "糞"], "долбаёб": 'バカ', "говна": ["うんこ", "クソ", "糞"], "долбаёба": 'バカ',  "говну": ["うんこ", "クソ", "糞"], "долбаёбу": 'バカ',
    "дерьмо": ["うんこ", "クソ", "糞", "クソ！", "チクショウ！", "くたばれ！", "ちくしょう"], "долбоеб": "バカ", "дерьму": ["うんこ", "クソ", "糞"], "долбоеба": "バカ",
...
"еблан": "バカ", "анал": "肛門", "ебланы": "クソ野郎ども",  "долбаёбы": "バカ者",     "хуета": ["うんこ", "クソ", "糞"], "хуита": ["うんこ", "クソ", "糞"], "долбаеб": 'バカ', "ебанат": "バカ", "долбаебы": "バカ者", "ебанаты": "バカ者", "хуете": ["うんこ", "クソ", "糞"], "хуету": ["うんこ", "クソ", "糞"],
"даун": "埋もれよ", "пизде": ["女性器", "プッシー", "まんこ"], "пизду": ["女性器", "プッシー", "まんこ"],
...
# --- Междометия и сленг (Exclamations & Slang) ---
    ...
    "короче": ["とにかく", "要するに"], "типа": ["みたいな", "って感じ"], "нуу": ["ええとー", "あのー"], "нууу": ["ええとーー", "あのーー"], "эм": "うーん", "хм": "ふむ",
"хэй": "おい", "ога": "うん", "ыгы": "うん",
    "ага": "うん", "угу": "うん", "окей": ["オッケー", "OK", "了解"], "ок": ["ОК", "了解"],
    "давай": ["じゃあ", "やろう"], "го": ["行こう", "やろう"],     "стоп": ["待って", "ストップ"], "помогите": '助けて', "хелп": "助けて",
"понятно": "なるほど", "эмм": "うーん", "хмм": "ふむ",
    ...
    "дал": "与えた", "дала": "与えた", "взял": "取った", "взяла": "取った", "взяли": "取った", "отдал": "渡した", "отдала": "渡した", "отдали": "渡した",
