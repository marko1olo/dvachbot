...
BOT_POST_CACHE_LIMIT = int(os.getenv("BOT_POST_CACHE_LIMIT", "1100"))
...
POST_COPY_RETENTION_DAYS = int(os.getenv("POST_COPY_RETENTION_DAYS", "3"))
...
BOT_PRIORITY_PASSIVE_SLICE_SIZE = int(os.getenv("BOT_PRIORITY_PASSIVE_SLICE_SIZE", "250"))
BOT_PRIORITY_PASSIVE_MEDIA_SLICE_SIZE = int(os.getenv("BOT_PRIORITY_PASSIVE_MEDIA_SLICE_SIZE", "120"))
BOT_PRIORITY_PRESSURE_SLICE_AGE_SEC = float(os.getenv("BOT_PRIORITY_PRESSURE_SLICE_AGE_SEC", "600"))
BOT_PRIORITY_PRESSURE_PASSIVE_SLICE_SIZE = int(os.getenv("BOT_PRIORITY_PRESSURE_PASSIVE_SLICE_SIZE", "150"))
BOT_PRIORITY_PRESSURE_PASSIVE_MEDIA_SLICE_SIZE = int(os.getenv("BOT_PRIORITY_PRESSURE_PASSIVE_MEDIA_SLICE_SIZE", "80"))
...
BOT_DELIVERY_INITIAL_CHUNK_SIZE = int(os.getenv("BOT_DELIVERY_INITIAL_CHUNK_SIZE", "25"))
BOT_DELIVERY_MAX_CHUNK_SIZE = int(os.getenv("BOT_DELIVERY_MAX_CHUNK_SIZE", "30"))
BOT_DELIVERY_MIN_CHUNK_SIZE = int(os.getenv("BOT_DELIVERY_MIN_CHUNK_SIZE", "10"))
