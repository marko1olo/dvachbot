...
BOT_PRIORITY_PASSIVE_SLICE_SIZE = int(os.getenv("BOT_PRIORITY_PASSIVE_SLICE_SIZE", "300"))
BOT_PRIORITY_PASSIVE_MEDIA_SLICE_SIZE = int(os.getenv("BOT_PRIORITY_PASSIVE_MEDIA_SLICE_SIZE", "150"))
