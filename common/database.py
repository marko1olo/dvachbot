        ...
        for attempt in range(10):
            try:
                ...
                if is_thread:
                    ...
                    for lst in _THREAD_CACHE.values():
                        try:
                            lst.remove(post_id_str)
                        except ValueError:
                            pass
                else:
                ...
                for lst in _VIDEO_CACHE.values():
                    lst[:] = [item for item in lst if item[0] != post_id_int]
                for lst in _IMAGE_CACHE.values():
                    lst[:] = [item for item in lst if item[0] != post_id_int]
