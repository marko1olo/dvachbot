...
async def _create_indexes_and_triggers(db):
...
async def _apply_migrations(db):
    """Применяет миграции и начальные данные."""
    ...
    migrations = [
        ...
        ("Users", "is_verified_b", "INTEGER DEFAULT 0"),
        ("Users", "reaction_reward_counter", "INTEGER DEFAULT 0"),
        ("Users", "posts_count", "INTEGER DEFAULT 0"),
        ("Users", "last_failed_amount", "REAL DEFAULT 0"),
        ("Users", "api_token", "TEXT"),
        ("Users", "nsfw_spoiler", "INTEGER DEFAULT 0"),
        ("Users", "hidden_words", "TEXT DEFAULT '[]'"),
        ("Users", "shadow_ban_gif", "INTEGER DEFAULT 0"),
        ("Users", "shadow_ban_sticker", "INTEGER DEFAULT 0"),
        ("Users", "shadow_ban_media", "INTEGER DEFAULT 0"),
        ("Users", "lie_media", "INTEGER DEFAULT 0"),
        ("Users", "role", "TEXT DEFAULT 'user'"),
        ("Boards", "banner_data", "TEXT DEFAULT '{}'"),
        ("Users", "stream", "TEXT DEFAULT 'ru'"),
        ("Posts", "stream", "TEXT DEFAULT 'ru'"),
        ("Threads", "stream", "TEXT DEFAULT 'ru'"),
        ("Threads", "is_pinned", "INTEGER DEFAULT 0"),
        ("Threads", "is_endless", "INTEGER DEFAULT 0"),
        ("Posts", "is_op_hidden", "INTEGER DEFAULT 0"),
        ("Posts", "ip", "TEXT"),
        ("Threads", "thread_num", "INTEGER DEFAULT 0"),
        ("NotificationQueue", "board_id", "TEXT DEFAULT 'b'"),
        ("NotificationQueue", "thread_id", "INTEGER"),
        ("NotificationQueue", "created_at", "REAL DEFAULT 0"),
        ("BroadcastQueue", "is_sent_to_tg", "INTEGER DEFAULT 0"),
        ("FileRegistry", "blurhash", "TEXT"),
        ("Users", "created_at", "REAL DEFAULT 0"),
        ("Boards", "is_approved", "INTEGER DEFAULT 1"),
        ("Boards", "owner_id", "INTEGER DEFAULT 0"),
        ("Posts", "channel_message_id", "INTEGER"),
        ("Posts", "report_count", "INTEGER DEFAULT 0"),
        ("Threads", "reply_count", "INTEGER DEFAULT 0"),
        ("Threads", "thread_type", "TEXT DEFAULT 'default'"),
        ("Posts", "is_shadow", "INTEGER DEFAULT 0")
    ]
...
async def initialize_database():
    try:
        async with aiosqlite.connect(DB_NAME, timeout=30.0, isolation_level=None) as db:
            ...
            await _create_indexes_and_triggers(db)
