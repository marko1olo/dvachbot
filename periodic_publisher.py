...
CAPTIONS = [
    "📊 <b>Еженедельная статистика — Базовый Срез (Часть 1/4)</b> 📊\n\n1. Объем высеров по дням\n2. Размер онлайна (WAU)\n3. Матоемкость борды\n4. Топ-10 главных шизоидов\n5. Топ-20 главных байтеров\n6. Длина постов (Одноклеточные vs Пасты)\n7. Клуб Полуночников vs Дневной онлайн\n8. Медиа-формат (Текст vs Фото/Видео/GIF/Стикеры)\n9. Уровень Дискуссии и Latency ответов\n10. Циркадные ритмы Анона\n\nСмотри графики в альбоме 👇",
    "🧠 <b>Продвинутая Аналитика и Социология (Часть 2/4)</b> 🧠\n\n11. Граф эхо-камер сообщества\n12. Топ-10 хабов внимания (PageRank)\n13. Топ-10 взаимных перепихонов (Circlejerk)\n14. Длина непрерывного залипания (Сессии)\n15. Мем-радар взлетающих трендов\n16. Частотный шитпост-словарь (Топ-30)\n17. Сентимент-анализ (Токсичность vs База)\n18. Лексическое разнообразие (MSTTR)\n19. Популярность разделов борды\n20. Неравенство шитпостинга (Кривая Лоренца)\n\nСмотри продолжение 👇",
    "🔥 <b>Ритмы, Календари и Динамика (Часть 3/4)</b> 🔥\n\n21. Тепловая карта час × день (180д)\n22. Ритм активности по дням (Ridge-плот)\n23. Часовой циферблат активности (Полярный)\n24. GitHub-календарь активности (180д)\n25. Кумулятивный рост постов борды\n26. Глубина цепочек ответов (Reply Depth)\n27. Радар здоровья борды\n28. Пузырьковая карта топ-тредов\n29. Тренд Медиа vs Текст (30д)\n30. Когорты новых авторов\n\nСмотри продолжение 👇",
    "🤖 <b>Глубокие Метрики и AI-Дайджест (Часть 4/4)</b> 🤖\n\n31. Недельная активность досок\n32. Стрик-чемпионы (Топ-20)\n33. Velocity Map скорости деградации\n34. Churned Users (Кто слился)\n35. Bump Chart рейтинга топ-авторов\n36. Хронотипы анонов (Карта сов и жаворонков)\n37. Матрица хайпа 7×24 со стрелками тренда\n38. Эмодзи-борда (Топ-20 эмодзи)\n39. Сеть тредов через общих авторов\n40. AI Weekly Digest (Нарратив от Llama-3.3-70B)\n\nФинал еженедельного отчета! 🚀"
]
