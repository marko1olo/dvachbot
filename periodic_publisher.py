...
CAPTIONS = [
    ...
    "🔥 <b>Ритмы и Тепловые Карты (Часть 3/4)</b> 🔥\n\nНовые графики: усредненная тепловая карта час × день за полгода, недельный Ridge-ритм, круговой циферблат активности и GitHub-style календарь за полгода.\nСмотри продолжение 👇",
    "🤖 <b>Расширенная Аналитика (Часть 4/4)</b> 🤖\n\nVelocity Map скорости деградации, churned users, bump chart рейтинга, хронотипы аноников, матрица хайпа со стрелками, эмодзи-борда, сеть тредов и AI-дайджест недели от Groq.\nФинал! 👇"
]
