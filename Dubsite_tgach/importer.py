                ...
                for row in rows:
                    ...
                    try:
                        ...
                        if refs:
                            missing_refs = []
                            for ref in refs:
                                if int(ref) in local_ref_map:
                                    replacements[int(ref)] = local_ref_map[int(ref)]
                                else:
                        ...
                        elif reply_to_orig and reply_to_orig in local_ref_map:
                            real_reply_to = local_ref_map[reply_to_orig]
