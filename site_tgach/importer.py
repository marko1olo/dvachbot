                ...
                for i in range(0, len(prepared_posts), chunk_size):
                    ...
                    for p_data in chunk:
                        ...
                        if fixed_text != original_text or reply_to_id is not None:
                            ...
                            update_queries.append((json.dumps(new_content_obj), reply_to_id, new_id))
                    ...
                    if update_queries:
                        await conn.executemany("UPDATE posts SET content = ?, reply_to_post_num = ? WHERE post_num = ?", update_queries)
