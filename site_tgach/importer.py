                ...
                for row in rows:
                    ...
                    try:
                        ...
                        if refs:
                            missing_refs = []
                            for ref in refs:
                                if str(ref) in local_ref_map:
                                    replacements[str(ref)] = local_ref_map[str(ref)]
                                else:
                        ...
                        elif reply_to_orig and str(reply_to_orig) in local_ref_map:
                            real_reply_to = local_ref_map[str(reply_to_orig)]
