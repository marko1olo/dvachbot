...
SPORT_INVENTS = [
    ...
    "чугунная ванна", "якорь", "двигатель от жигулей", "булыжник",
    "булыжник с говном"
]
...
async def conan_roaster(state, messages_storage, post_to_messages, message_to_post, message_queues, format_header, board_data, storage_lock):
    ...
    while True:
        try:
            await asyncio.sleep(secrets.randbelow(30600) + 60000)
            ...
            async with storage_lock:
                ...
                new_pnum = state['post_counter']

                # 2. Выбираем пост для ответа
                valid_posts = [
            ...
            # Снова берем блокировку для записи в общие хранилища
            async with storage_lock:
            ...
            if new_pnum and content:
                ...
                print(f"✅ [{board_id}] Conan reply to #{post_num_to_reply} added to queue: {content['text'][:50]}...")
